...
Assert-Case 'Current full G4 contract accepted' $true
Assert-Case 'G4 identity advertised' ($ControlFGBuild.Version -ceq '1.0.0-RR-Native-G4')
...
Write-Host ('G4_CONTRACT_FIXTURES=PASS COUNT='+$results.Count)
