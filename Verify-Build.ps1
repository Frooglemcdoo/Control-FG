...
try {
    ...
    $markers = @(
        ...
        'hit_distance=D1_optional','specular_mvec=cleared','reflection_mvec=cleared','matrix_mode=GI26_F_native_world_to_view_plus_projection_E_identity','RR_GI26_SPECULAR_CAMERA','RR_F_DISTANCE_D1','RR_F_DISTANCE_D1_INSTALL','RR_CLAMP_STRENGTH_CS3','RR_CLAMP_CS3_CAPTURE','RR_SPECULAR_SIGNAL frame=%llu mode=native_control_energy_clamp','RR_INPUT_CAPTURE_C1_REQUEST','RR_INPUT_CAPTURE_C1_RECORDED','RR_INPUT_CAPTURE_C1_EXPORTED','RR_REFLECTION_COPIED','RR_REFLECTION_PREPARED','RR_DISTANCE_RECORDED','RR_DISTANCE_PREPARED',
