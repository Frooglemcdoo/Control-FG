...
try {
    ...
    foreach ($name in @('sl.h','sl_consts.h','sl_core_api.h','sl_core_types.h','sl_reflex.h','sl_dlss_g.h','sl_pcl.h')) {
    ...
    foreach ($name in @('sl.interposer.dll','sl.common.dll','sl.pcl.dll','sl.reflex.dll','sl.dlss_g.dll','nvngx_dlssg.dll')) {
