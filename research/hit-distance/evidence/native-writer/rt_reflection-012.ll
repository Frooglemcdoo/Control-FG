...
"\01?internal.getWorldSpaceNoiseOffset@@YA?AV?$vector@I$01@@V?$vector@M$01@@V?$matrix@M$03$03@@10MV?$vector@M$02@@22M_N@Z.exit33":
  ...
  %FMad84 = call float @dx.op.tertiary.f32(i32 46, float %.i1157433, float %60, float %74)  ; FMad(a,b,c)
  %FMad83 = call float @dx.op.tertiary.f32(i32 46, float %17, float %65, float %FMad84)  ; FMad(a,b,c)
  %75 = fadd fast float %FMad83, %70
  %76 = fmul fast float %56, %.i0156
  %FMad81 = call float @dx.op.tertiary.f32(i32 46, float %.i1157433, float %61, float %76)  ; FMad(a,b,c)
  %FMad80 = call float @dx.op.tertiary.f32(i32 46, float %17, float %66, float %FMad81)  ; FMad(a,b,c)
  %77 = fadd fast float %FMad80, %71
  %78 = fmul fast float %57, %.i0156
  %FMad78 = call float @dx.op.tertiary.f32(i32 46, float %.i1157433, float %62, float %78)  ; FMad(a,b,c)
  %FMad77 = call float @dx.op.tertiary.f32(i32 46, float %17, float %67, float %FMad78)  ; FMad(a,b,c)
  %79 = fadd fast float %FMad77, %72
  %80 = fmul fast float %58, %.i0156
  %FMad75 = call float @dx.op.tertiary.f32(i32 46, float %.i1157433, float %63, float %80)  ; FMad(a,b,c)
  %FMad74 = call float @dx.op.tertiary.f32(i32 46, float %17, float %68, float %FMad75)  ; FMad(a,b,c)
  %81 = fadd fast float %FMad74, %73
  ...
  %FMad114 = call float @dx.op.tertiary.f32(i32 46, float %.i1207, float %123, float %130)  ; FMad(a,b,c)
  %FMad113 = call float @dx.op.tertiary.f32(i32 46, float %.i2208, float %127, float %FMad114)  ; FMad(a,b,c)
  %131 = fmul fast float %120, %.i0206
  %FMad112 = call float @dx.op.tertiary.f32(i32 46, float %.i1207, float %124, float %131)  ; FMad(a,b,c)
  %FMad111 = call float @dx.op.tertiary.f32(i32 46, float %.i2208, float %128, float %FMad112)  ; FMad(a,b,c)
  %132 = fmul fast float %121, %.i0206
  %FMad110 = call float @dx.op.tertiary.f32(i32 46, float %.i1207, float %125, float %132)  ; FMad(a,b,c)
  %FMad109 = call float @dx.op.tertiary.f32(i32 46, float %.i2208, float %129, float %FMad110)  ; FMad(a,b,c)
  ...
  %.i0221 = fmul fast float %.i0209, %FMad113
  %.i1222 = fmul fast float %.i0209, %FMad111
  %.i2223 = fmul fast float %.i0209, %FMad109
  ...
  store <3 x float> %133, <3 x float>* %134, align 4, !tbaa !528
  %135 = getelementptr inbounds %struct.RayDesc, %struct.RayDesc* %ray, i32 0, i32 1
  store float 0.000000e+00, float* %135, align 4, !tbaa !543
  ...
  %.i0231 = fmul fast float %FMad113, 4.000000e+00
  %.i1232 = fmul fast float %FMad111, 4.000000e+00
  %.i2233 = fmul fast float %FMad109, 4.000000e+00
  ...
  %FMad104 = call float @dx.op.tertiary.f32(i32 46, float %17, float %142, float 0.000000e+00)  ; FMad(a,b,c)
  %176 = fadd fast float %FMad104, %145
  %FMad98 = call float @dx.op.tertiary.f32(i32 46, float %17, float %143, float 0.000000e+00)  ; FMad(a,b,c)
  %177 = fadd fast float %FMad98, %146
  %178 = fdiv fast float 1.000000e+00, %177
  %.i1238 = fmul fast float %178, %176
  %179 = fdiv fast float 2.000000e+00, %165
  %FMad141 = call float @dx.op.tertiary.f32(i32 46, float %179, float %139, float 0.000000e+00)  ; FMad(a,b,c)
  %FMad140 = call float @dx.op.tertiary.f32(i32 46, float %17, float %142, float %FMad141)  ; FMad(a,b,c)
  %180 = fadd fast float %FMad140, %145
  %FMad135 = call float @dx.op.tertiary.f32(i32 46, float %179, float %140, float 0.000000e+00)  ; FMad(a,b,c)
  %FMad134 = call float @dx.op.tertiary.f32(i32 46, float %17, float %143, float %FMad135)  ; FMad(a,b,c)
  %181 = fadd fast float %FMad134, %146
  ...
  store i32 0, i32* %188, align 4, !tbaa !536
  ...
  %216 = load float, float* %166, align 4, !tbaa !543
  ...
  %222 = load float, float* %167, align 4, !tbaa !543
  ...
  %228 = load float, float* %168, align 4, !tbaa !543
  ...
  store float 0.000000e+00, float* %237, align 4, !tbaa !543
  ...
  %FMad126 = call float @dx.op.tertiary.f32(i32 46, float %.i1337, float %152, float %258)  ; FMad(a,b,c)
  %FMad125 = call float @dx.op.tertiary.f32(i32 46, float %.i2338, float %156, float %FMad126)  ; FMad(a,b,c)
  %259 = fadd fast float %FMad125, %160
  %260 = fmul fast float %.i0336, %149
  %FMad123 = call float @dx.op.tertiary.f32(i32 46, float %.i1337, float %153, float %260)  ; FMad(a,b,c)
  %FMad122 = call float @dx.op.tertiary.f32(i32 46, float %.i2338, float %157, float %FMad123)  ; FMad(a,b,c)
  %261 = fadd fast float %FMad122, %161
  %262 = fmul fast float %.i0336, %150
  %FMad117 = call float @dx.op.tertiary.f32(i32 46, float %.i1337, float %154, float %262)  ; FMad(a,b,c)
  %FMad116 = call float @dx.op.tertiary.f32(i32 46, float %.i2338, float %158, float %FMad117)  ; FMad(a,b,c)
  %263 = fadd fast float %FMad116, %162
...
._crit_edge:                                      ; preds = %.lr.ph, %.lr.ph30
  ...
  %FMad132 = call float @dx.op.tertiary.f32(i32 46, float %.i1292, float %277, float %284)  ; FMad(a,b,c)
  %FMad131 = call float @dx.op.tertiary.f32(i32 46, float %.i2293, float %281, float %FMad132)  ; FMad(a,b,c)
  %285 = fmul fast float %274, %.i0291
  %FMad130 = call float @dx.op.tertiary.f32(i32 46, float %.i1292, float %278, float %285)  ; FMad(a,b,c)
  %FMad129 = call float @dx.op.tertiary.f32(i32 46, float %.i2293, float %282, float %FMad130)  ; FMad(a,b,c)
  %286 = fmul fast float %275, %.i0291
  %FMad128 = call float @dx.op.tertiary.f32(i32 46, float %.i1292, float %279, float %286)  ; FMad(a,b,c)
  %FMad127 = call float @dx.op.tertiary.f32(i32 46, float %.i2293, float %283, float %FMad128)  ; FMad(a,b,c)
...
._crit_edge.31.loopexit:                          ; preds = %._crit_edge
  ...
  %FMad127.lcssa = phi float [ %FMad127, %._crit_edge ]
  %FMad129.lcssa = phi float [ %FMad129, %._crit_edge ]
  %FMad131.lcssa = phi float [ %FMad131, %._crit_edge ]
  %292 = getelementptr inbounds %struct.RayDesc, %struct.RayDesc* %ray, i32 0, i32 3
  %293 = insertelement <3 x float> undef, float %FMad131.lcssa, i64 0
  %294 = insertelement <3 x float> %293, float %FMad129.lcssa, i64 1
  %295 = insertelement <3 x float> %294, float %FMad127.lcssa, i64 2
