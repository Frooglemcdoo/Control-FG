...
define void @"\01?reflectionRayGeneration@@YAXXZ"() #0 {
  ...
  %FMad136 = call float @dx.op.tertiary.f32(i32 46, float %.i1173487, float %66, float %80)  ; FMad(a,b,c)
  %FMad135 = call float @dx.op.tertiary.f32(i32 46, float %23, float %71, float %FMad136)  ; FMad(a,b,c)
  %81 = fadd fast float %FMad135, %76
  %82 = fmul fast float %62, %.i0172
  %FMad133 = call float @dx.op.tertiary.f32(i32 46, float %.i1173487, float %67, float %82)  ; FMad(a,b,c)
  %FMad132 = call float @dx.op.tertiary.f32(i32 46, float %23, float %72, float %FMad133)  ; FMad(a,b,c)
  %83 = fadd fast float %FMad132, %77
  %84 = fmul fast float %63, %.i0172
  %FMad130 = call float @dx.op.tertiary.f32(i32 46, float %.i1173487, float %68, float %84)  ; FMad(a,b,c)
  %FMad129 = call float @dx.op.tertiary.f32(i32 46, float %23, float %73, float %FMad130)  ; FMad(a,b,c)
  %85 = fadd fast float %FMad129, %78
  %86 = fmul fast float %64, %.i0172
  %FMad127 = call float @dx.op.tertiary.f32(i32 46, float %.i1173487, float %69, float %86)  ; FMad(a,b,c)
  %FMad126 = call float @dx.op.tertiary.f32(i32 46, float %23, float %74, float %FMad127)  ; FMad(a,b,c)
  %87 = fadd fast float %FMad126, %79
  ...
  %FMad100 = call float @dx.op.tertiary.f32(i32 46, float %.i1223, float %129, float %136)  ; FMad(a,b,c)
  %FMad99 = call float @dx.op.tertiary.f32(i32 46, float %.i2224, float %133, float %FMad100)  ; FMad(a,b,c)
  %137 = fmul fast float %126, %.i0222
  %FMad98 = call float @dx.op.tertiary.f32(i32 46, float %.i1223, float %130, float %137)  ; FMad(a,b,c)
  %FMad97 = call float @dx.op.tertiary.f32(i32 46, float %.i2224, float %134, float %FMad98)  ; FMad(a,b,c)
  %138 = fmul fast float %127, %.i0222
  %FMad96 = call float @dx.op.tertiary.f32(i32 46, float %.i1223, float %131, float %138)  ; FMad(a,b,c)
  %FMad95 = call float @dx.op.tertiary.f32(i32 46, float %.i2224, float %135, float %FMad96)  ; FMad(a,b,c)
  ...
  %.i0237 = fmul fast float %.i0225, %FMad99
  %.i1238 = fmul fast float %.i0225, %FMad97
  %.i2239 = fmul fast float %.i0225, %FMad95
  ...
  store <3 x float> %139, <3 x float>* %140, align 4, !tbaa !531
  %141 = getelementptr inbounds %struct.RayDesc, %struct.RayDesc* %ray, i32 0, i32 1
  store float 0.000000e+00, float* %141, align 4, !tbaa !546
...
"\01?internal.getMaterialSpecular@@YA?AV?$vector@M$02@@IM@Z.exit": ; preds = %164, %0
  ...
  %169 = call float @dx.op.dot3.f32(i32 55, float %FMad99, float %FMad97, float %FMad95, float %.i0261, float %.i1262, float %.i2263)  ; Dot3(ax,ay,az,bx,by,bz)
...
"\01?internal.getReflectionRayCount@@YAHV?$vector@M$02@@M@Z.exit": ; preds = %178, %"\01?internal.getMaterialSpecular@@YA?AV?$vector@M$02@@IM@Z.exit"
  ...
  %.i0277 = fmul fast float %FMad99, 4.000000e+00
  %.i1278 = fmul fast float %FMad97, 4.000000e+00
  %.i2279 = fmul fast float %FMad95, 4.000000e+00
  ...
  %FMad90 = call float @dx.op.tertiary.f32(i32 46, float %23, float %195, float 0.000000e+00)  ; FMad(a,b,c)
  %229 = fadd fast float %FMad90, %198
  %FMad84 = call float @dx.op.tertiary.f32(i32 46, float %23, float %196, float 0.000000e+00)  ; FMad(a,b,c)
  %230 = fadd fast float %FMad84, %199
  %231 = fdiv fast float 1.000000e+00, %230
  %.i1284 = fmul fast float %231, %229
  %232 = fdiv fast float 2.000000e+00, %218
  %FMad109 = call float @dx.op.tertiary.f32(i32 46, float %232, float %192, float 0.000000e+00)  ; FMad(a,b,c)
  %FMad108 = call float @dx.op.tertiary.f32(i32 46, float %23, float %195, float %FMad109)  ; FMad(a,b,c)
  %233 = fadd fast float %FMad108, %198
  %FMad103 = call float @dx.op.tertiary.f32(i32 46, float %232, float %193, float 0.000000e+00)  ; FMad(a,b,c)
  %FMad102 = call float @dx.op.tertiary.f32(i32 46, float %23, float %196, float %FMad103)  ; FMad(a,b,c)
  %234 = fadd fast float %FMad102, %199
  ...
  store i32 0, i32* %241, align 4, !tbaa !539
  ...
  %269 = load float, float* %219, align 4, !tbaa !546
  ...
  %275 = load float, float* %220, align 4, !tbaa !546
  ...
  %281 = load float, float* %221, align 4, !tbaa !546
  ...
  store float 0.000000e+00, float* %290, align 4, !tbaa !546
  ...
  %FMad154 = call float @dx.op.tertiary.f32(i32 46, float %.i1383, float %205, float %311)  ; FMad(a,b,c)
  %FMad153 = call float @dx.op.tertiary.f32(i32 46, float %.i2384, float %209, float %FMad154)  ; FMad(a,b,c)
  %312 = fadd fast float %FMad153, %213
  %313 = fmul fast float %.i0382, %202
  %FMad151 = call float @dx.op.tertiary.f32(i32 46, float %.i1383, float %206, float %313)  ; FMad(a,b,c)
  %FMad150 = call float @dx.op.tertiary.f32(i32 46, float %.i2384, float %210, float %FMad151)  ; FMad(a,b,c)
  %314 = fadd fast float %FMad150, %214
  %315 = fmul fast float %.i0382, %203
  %FMad145 = call float @dx.op.tertiary.f32(i32 46, float %.i1383, float %207, float %315)  ; FMad(a,b,c)
  %FMad144 = call float @dx.op.tertiary.f32(i32 46, float %.i2384, float %211, float %FMad145)  ; FMad(a,b,c)
  %316 = fadd fast float %FMad144, %215
...
._crit_edge:                                      ; preds = %.lr.ph, %.lr.ph31
  ...
  %FMad142 = call float @dx.op.tertiary.f32(i32 46, float %.i1338, float %330, float %337)  ; FMad(a,b,c)
  %FMad141 = call float @dx.op.tertiary.f32(i32 46, float %.i2339, float %334, float %FMad142)  ; FMad(a,b,c)
  %338 = fmul fast float %327, %.i0337
  %FMad140 = call float @dx.op.tertiary.f32(i32 46, float %.i1338, float %331, float %338)  ; FMad(a,b,c)
  %FMad139 = call float @dx.op.tertiary.f32(i32 46, float %.i2339, float %335, float %FMad140)  ; FMad(a,b,c)
  %339 = fmul fast float %328, %.i0337
  %FMad138 = call float @dx.op.tertiary.f32(i32 46, float %.i1338, float %332, float %339)  ; FMad(a,b,c)
  %FMad137 = call float @dx.op.tertiary.f32(i32 46, float %.i2339, float %336, float %FMad138)  ; FMad(a,b,c)
  ...
  call void @dx.op.traceRay.struct.HitData(i32 157, %dx.types.Handle %343, i32 0, i32 1, i32 0, i32 2, i32 0, float %352, float %353, float %354, float %355, float %FMad141, float %FMad139, float %FMad137, float %342, %struct.HitData* nonnull %16)  ; TraceRay(AccelerationStructure,RayFlags,InstanceInclusionMask,RayContributionToHitGroupIndex,MultiplierForGeometryContributionToShaderIndex,MissShaderIndex,Origin_X,Origin_Y,Origin_Z,TMin,Direction_X,Direction_Y,Direction_Z,TMax,payload)
...
._crit_edge.32.loopexit:                          ; preds = %._crit_edge
  ...
  %FMad137.lcssa = phi float [ %FMad137, %._crit_edge ]
  ...
  %346 = insertelement <3 x float> undef, float %FMad141.lcssa, i64 0
  %347 = insertelement <3 x float> %346, float %FMad139.lcssa, i64 1
  %348 = insertelement <3 x float> %347, float %FMad137.lcssa, i64 2
