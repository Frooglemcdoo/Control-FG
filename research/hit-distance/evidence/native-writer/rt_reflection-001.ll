...
"\01?internal.getWorldSpaceNoiseOffset@@YA?AV?$vector@I$01@@V?$vector@M$01@@V?$matrix@M$03$03@@10MV?$vector@M$02@@22M_N@Z.exit33":
  ...
  %FMad140 = call float @dx.op.tertiary.f32(i32 46, float %17, float %144, float 0.000000e+00)  ; FMad(a,b,c)
  %178 = fadd fast float %FMad140, %147
  %FMad134 = call float @dx.op.tertiary.f32(i32 46, float %17, float %145, float 0.000000e+00)  ; FMad(a,b,c)
  ...
  %FMad129 = call float @dx.op.tertiary.f32(i32 46, float %181, float %141, float 0.000000e+00)  ; FMad(a,b,c)
  %FMad128 = call float @dx.op.tertiary.f32(i32 46, float %17, float %144, float %FMad129)  ; FMad(a,b,c)
  %182 = fadd fast float %FMad128, %147
  %FMad123 = call float @dx.op.tertiary.f32(i32 46, float %181, float %142, float 0.000000e+00)  ; FMad(a,b,c)
  %FMad122 = call float @dx.op.tertiary.f32(i32 46, float %17, float %145, float %FMad123)  ; FMad(a,b,c)
  %183 = fadd fast float %FMad122, %148
  ...
  %FMad114 = call float @dx.op.tertiary.f32(i32 46, float %.i1337, float %154, float %260)  ; FMad(a,b,c)
  %FMad113 = call float @dx.op.tertiary.f32(i32 46, float %.i2338, float %158, float %FMad114)  ; FMad(a,b,c)
  %261 = fadd fast float %FMad113, %162
  %262 = fmul fast float %.i0336, %151
  %FMad111 = call float @dx.op.tertiary.f32(i32 46, float %.i1337, float %155, float %262)  ; FMad(a,b,c)
  %FMad110 = call float @dx.op.tertiary.f32(i32 46, float %.i2338, float %159, float %FMad111)  ; FMad(a,b,c)
  %263 = fadd fast float %FMad110, %163
  %264 = fmul fast float %.i0336, %152
  %FMad105 = call float @dx.op.tertiary.f32(i32 46, float %.i1337, float %156, float %264)  ; FMad(a,b,c)
  %FMad104 = call float @dx.op.tertiary.f32(i32 46, float %.i2338, float %160, float %FMad105)  ; FMad(a,b,c)
...
._crit_edge:                                      ; preds = %._crit_edge.loopexit, %"\01?internal.getImportanceRay@@YA?AV?$vector@M$02@@V1@0MV?$vector@M$01@@@Z.exit"
  ...
  %FMad102 = call float @dx.op.tertiary.f32(i32 46, float %vReflectionDirectionInView.0.lcssa.i1, float %324, float %331)  ; FMad(a,b,c)
  %FMad101 = call float @dx.op.tertiary.f32(i32 46, float %vReflectionDirectionInView.0.lcssa.i2, float %328, float %FMad102)  ; FMad(a,b,c)
  %332 = fmul fast float %321, %vReflectionDirectionInView.0.lcssa.i0
  %FMad100 = call float @dx.op.tertiary.f32(i32 46, float %vReflectionDirectionInView.0.lcssa.i1, float %325, float %332)  ; FMad(a,b,c)
  %FMad99 = call float @dx.op.tertiary.f32(i32 46, float %vReflectionDirectionInView.0.lcssa.i2, float %329, float %FMad100)  ; FMad(a,b,c)
  %333 = fmul fast float %322, %vReflectionDirectionInView.0.lcssa.i0
  %FMad98 = call float @dx.op.tertiary.f32(i32 46, float %vReflectionDirectionInView.0.lcssa.i1, float %326, float %333)  ; FMad(a,b,c)
  %FMad97 = call float @dx.op.tertiary.f32(i32 46, float %vReflectionDirectionInView.0.lcssa.i2, float %330, float %FMad98)  ; FMad(a,b,c)
...
._crit_edge.31.loopexit:                          ; preds = %._crit_edge
  ...
  %341 = insertelement <3 x float> undef, float %FMad101.lcssa, i64 0
  %342 = insertelement <3 x float> %341, float %FMad99.lcssa, i64 1
  %343 = insertelement <3 x float> %342, float %FMad97.lcssa, i64 2
