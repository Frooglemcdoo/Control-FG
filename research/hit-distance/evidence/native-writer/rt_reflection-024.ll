...
define void @"\01?reflectionRayGeneration@@YAXXZ"() #0 {
  ...
  %FMad106 = call float @dx.op.tertiary.f32(i32 46, float %.i1173487, float %32, float %46)  ; FMad(a,b,c)
  %FMad105 = call float @dx.op.tertiary.f32(i32 46, float %23, float %37, float %FMad106)  ; FMad(a,b,c)
  %47 = fadd fast float %FMad105, %42
  %48 = fmul fast float %28, %.i0172
  %FMad103 = call float @dx.op.tertiary.f32(i32 46, float %.i1173487, float %33, float %48)  ; FMad(a,b,c)
  %FMad102 = call float @dx.op.tertiary.f32(i32 46, float %23, float %38, float %FMad103)  ; FMad(a,b,c)
  %49 = fadd fast float %FMad102, %43
  %50 = fmul fast float %29, %.i0172
  %FMad100 = call float @dx.op.tertiary.f32(i32 46, float %.i1173487, float %34, float %50)  ; FMad(a,b,c)
  %FMad99 = call float @dx.op.tertiary.f32(i32 46, float %23, float %39, float %FMad100)  ; FMad(a,b,c)
  %51 = fadd fast float %FMad99, %44
  %52 = fmul fast float %30, %.i0172
  %FMad97 = call float @dx.op.tertiary.f32(i32 46, float %.i1173487, float %35, float %52)  ; FMad(a,b,c)
  %FMad96 = call float @dx.op.tertiary.f32(i32 46, float %23, float %40, float %FMad97)  ; FMad(a,b,c)
  %53 = fadd fast float %FMad96, %45
  ...
  %FMad142 = call float @dx.op.tertiary.f32(i32 46, float %.i1223, float %130, float %137)  ; FMad(a,b,c)
  %FMad141 = call float @dx.op.tertiary.f32(i32 46, float %.i2224, float %134, float %FMad142)  ; FMad(a,b,c)
  %138 = fmul fast float %127, %.i0222
  %FMad140 = call float @dx.op.tertiary.f32(i32 46, float %.i1223, float %131, float %138)  ; FMad(a,b,c)
  %FMad139 = call float @dx.op.tertiary.f32(i32 46, float %.i2224, float %135, float %FMad140)  ; FMad(a,b,c)
  %139 = fmul fast float %128, %.i0222
  %FMad138 = call float @dx.op.tertiary.f32(i32 46, float %.i1223, float %132, float %139)  ; FMad(a,b,c)
  %FMad137 = call float @dx.op.tertiary.f32(i32 46, float %.i2224, float %136, float %FMad138)  ; FMad(a,b,c)
  ...
  %.i0237 = fmul fast float %.i0225, %FMad141
  %.i1238 = fmul fast float %.i0225, %FMad139
  %.i2239 = fmul fast float %.i0225, %FMad137
...
"\01?internal.getMaterialSpecular@@YA?AV?$vector@M$02@@IM@Z.exit": ; preds = %166, %0
  ...
  %171 = call float @dx.op.dot3.f32(i32 55, float %FMad141, float %FMad139, float %FMad137, float %.i0261, float %.i1262, float %.i2263)  ; Dot3(ax,ay,az,bx,by,bz)
...
"\01?internal.getReflectionRayCount@@YAHV?$vector@M$02@@M@Z.exit": ; preds = %191, %"\01?internal.getMaterialSpecular@@YA?AV?$vector@M$02@@IM@Z.exit"
  ...
  %.i0277 = fmul fast float %FMad141, 4.000000e+00
  %.i1278 = fmul fast float %FMad139, 4.000000e+00
  %.i2279 = fmul fast float %FMad137, 4.000000e+00
  ...
  %FMad150 = call float @dx.op.tertiary.f32(i32 46, float %23, float %203, float 0.000000e+00)  ; FMad(a,b,c)
  %237 = fadd fast float %FMad150, %206
  %FMad144 = call float @dx.op.tertiary.f32(i32 46, float %23, float %204, float 0.000000e+00)  ; FMad(a,b,c)
  %238 = fadd fast float %FMad144, %207
  %239 = fdiv fast float 1.000000e+00, %238
  %.i1284 = fmul fast float %239, %237
  %240 = fdiv fast float 2.000000e+00, %226
  %FMad133 = call float @dx.op.tertiary.f32(i32 46, float %240, float %200, float 0.000000e+00)  ; FMad(a,b,c)
  %FMad132 = call float @dx.op.tertiary.f32(i32 46, float %23, float %203, float %FMad133)  ; FMad(a,b,c)
  %241 = fadd fast float %FMad132, %206
  %FMad127 = call float @dx.op.tertiary.f32(i32 46, float %240, float %201, float 0.000000e+00)  ; FMad(a,b,c)
  %FMad126 = call float @dx.op.tertiary.f32(i32 46, float %23, float %204, float %FMad127)  ; FMad(a,b,c)
  %242 = fadd fast float %FMad126, %207
  ...
  store i32 0, i32* %249, align 4, !tbaa !541
  ...
  %277 = load float, float* %227, align 4, !tbaa !548
  ...
  %283 = load float, float* %228, align 4, !tbaa !548
  ...
  %289 = load float, float* %229, align 4, !tbaa !548
  ...
  store float 0.000000e+00, float* %298, align 4, !tbaa !548
  ...
  %FMad118 = call float @dx.op.tertiary.f32(i32 46, float %.i1383, float %213, float %319)  ; FMad(a,b,c)
  %FMad117 = call float @dx.op.tertiary.f32(i32 46, float %.i2384, float %217, float %FMad118)  ; FMad(a,b,c)
  %320 = fadd fast float %FMad117, %221
  %321 = fmul fast float %.i0382, %210
  %FMad115 = call float @dx.op.tertiary.f32(i32 46, float %.i1383, float %214, float %321)  ; FMad(a,b,c)
  %FMad114 = call float @dx.op.tertiary.f32(i32 46, float %.i2384, float %218, float %FMad115)  ; FMad(a,b,c)
  %322 = fadd fast float %FMad114, %222
  %323 = fmul fast float %.i0382, %211
  %FMad109 = call float @dx.op.tertiary.f32(i32 46, float %.i1383, float %215, float %323)  ; FMad(a,b,c)
  %FMad108 = call float @dx.op.tertiary.f32(i32 46, float %.i2384, float %219, float %FMad109)  ; FMad(a,b,c)
  %324 = fadd fast float %FMad108, %223
...
._crit_edge:                                      ; preds = %._crit_edge.loopexit, %"\01?internal.getImportanceRay@@YA?AV?$vector@M$02@@V1@0MV?$vector@M$01@@@Z.exit13"
  ...
  %FMad124 = call float @dx.op.tertiary.f32(i32 46, float %vReflectionDirectionInView.0.lcssa.i1, float %383, float %390)  ; FMad(a,b,c)
  %FMad123 = call float @dx.op.tertiary.f32(i32 46, float %vReflectionDirectionInView.0.lcssa.i2, float %387, float %FMad124)  ; FMad(a,b,c)
  %391 = fmul fast float %380, %vReflectionDirectionInView.0.lcssa.i0
  %FMad122 = call float @dx.op.tertiary.f32(i32 46, float %vReflectionDirectionInView.0.lcssa.i1, float %384, float %391)  ; FMad(a,b,c)
  %FMad121 = call float @dx.op.tertiary.f32(i32 46, float %vReflectionDirectionInView.0.lcssa.i2, float %388, float %FMad122)  ; FMad(a,b,c)
  %392 = fmul fast float %381, %vReflectionDirectionInView.0.lcssa.i0
  %FMad120 = call float @dx.op.tertiary.f32(i32 46, float %vReflectionDirectionInView.0.lcssa.i1, float %385, float %392)  ; FMad(a,b,c)
  %FMad119 = call float @dx.op.tertiary.f32(i32 46, float %vReflectionDirectionInView.0.lcssa.i2, float %389, float %FMad120)  ; FMad(a,b,c)
  ...
  call void @dx.op.traceRay.struct.HitData(i32 157, %dx.types.Handle %396, i32 0, i32 1, i32 0, i32 2, i32 0, float %411, float %412, float %413, float %414, float %FMad123, float %FMad121, float %FMad119, float %395, %struct.HitData* nonnull %16)  ; TraceRay(AccelerationStructure,RayFlags,InstanceInclusionMask,RayContributionToHitGroupIndex,MultiplierForGeometryContributionToShaderIndex,MissShaderIndex,Origin_X,Origin_Y,Origin_Z,TMin,Direction_X,Direction_Y,Direction_Z,TMax,payload)
...
._crit_edge.32.loopexit:                          ; preds = %._crit_edge
  ...
  %FMad119.lcssa = phi float [ %FMad119, %._crit_edge ]
  ...
  %400 = insertelement <3 x float> undef, float %FMad123.lcssa, i64 0
  %401 = insertelement <3 x float> %400, float %FMad121.lcssa, i64 1
  %402 = insertelement <3 x float> %401, float %FMad119.lcssa, i64 2
