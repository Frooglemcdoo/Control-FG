...
"\01?internal.getWorldSpaceNoiseOffset@@YA?AV?$vector@I$01@@V?$vector@M$01@@V?$matrix@M$03$03@@10MV?$vector@M$02@@22M_N@Z.exit33":
  ...
  %FMad132 = call float @dx.op.tertiary.f32(i32 46, float %.i1157433, float %26, float %40)  ; FMad(a,b,c)
  %FMad131 = call float @dx.op.tertiary.f32(i32 46, float %17, float %31, float %FMad132)  ; FMad(a,b,c)
  %41 = fadd fast float %FMad131, %36
  %42 = fmul fast float %22, %.i0156
  %FMad129 = call float @dx.op.tertiary.f32(i32 46, float %.i1157433, float %27, float %42)  ; FMad(a,b,c)
  %FMad128 = call float @dx.op.tertiary.f32(i32 46, float %17, float %32, float %FMad129)  ; FMad(a,b,c)
  %43 = fadd fast float %FMad128, %37
  %44 = fmul fast float %23, %.i0156
  %FMad126 = call float @dx.op.tertiary.f32(i32 46, float %.i1157433, float %28, float %44)  ; FMad(a,b,c)
  %FMad125 = call float @dx.op.tertiary.f32(i32 46, float %17, float %33, float %FMad126)  ; FMad(a,b,c)
  %45 = fadd fast float %FMad125, %38
  %46 = fmul fast float %24, %.i0156
  %FMad123 = call float @dx.op.tertiary.f32(i32 46, float %.i1157433, float %29, float %46)  ; FMad(a,b,c)
  %FMad122 = call float @dx.op.tertiary.f32(i32 46, float %17, float %34, float %FMad123)  ; FMad(a,b,c)
  %47 = fadd fast float %FMad122, %39
  ...
  store <3 x float> %135, <3 x float>* %136, align 4, !tbaa !515
  %137 = getelementptr inbounds %struct.RayDesc, %struct.RayDesc* %ray, i32 0, i32 1
  store float 0.000000e+00, float* %137, align 4, !tbaa !518
  ...
  %FMad80 = call float @dx.op.tertiary.f32(i32 46, float %17, float %144, float %FMad81)  ; FMad(a,b,c)
  ...
  %FMad74 = call float @dx.op.tertiary.f32(i32 46, float %17, float %145, float %FMad75)  ; FMad(a,b,c)
  ...
  store i32 0, i32* %190, align 4, !tbaa !520
  ...
  %218 = load float, float* %168, align 4, !tbaa !518
  ...
  %224 = load float, float* %169, align 4, !tbaa !518
  ...
  %230 = load float, float* %170, align 4, !tbaa !518
  ...
  store float 0.000000e+00, float* %239, align 4, !tbaa !518
  ...
  %FMad144 = call float @dx.op.tertiary.f32(i32 46, float %.i1337, float %154, float %260)  ; FMad(a,b,c)
  %FMad143 = call float @dx.op.tertiary.f32(i32 46, float %.i2338, float %158, float %FMad144)  ; FMad(a,b,c)
  %261 = fadd fast float %FMad143, %162
  %262 = fmul fast float %.i0336, %151
  %FMad141 = call float @dx.op.tertiary.f32(i32 46, float %.i1337, float %155, float %262)  ; FMad(a,b,c)
  %FMad140 = call float @dx.op.tertiary.f32(i32 46, float %.i2338, float %159, float %FMad141)  ; FMad(a,b,c)
  %263 = fadd fast float %FMad140, %163
  %264 = fmul fast float %.i0336, %152
  %FMad135 = call float @dx.op.tertiary.f32(i32 46, float %.i1337, float %156, float %264)  ; FMad(a,b,c)
  %FMad134 = call float @dx.op.tertiary.f32(i32 46, float %.i2338, float %160, float %FMad135)  ; FMad(a,b,c)
  %265 = fadd fast float %FMad134, %164
