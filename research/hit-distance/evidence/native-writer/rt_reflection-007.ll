...
"\01?internal.getWorldSpaceNoiseOffset@@YA?AV?$vector@I$01@@V?$vector@M$01@@V?$matrix@M$03$03@@10MV?$vector@M$02@@22M_N@Z.exit33":
  ...
  %FMad102 = call float @dx.op.tertiary.f32(i32 46, float %.i1163453, float %62, float %76)  ; FMad(a,b,c)
  %FMad101 = call float @dx.op.tertiary.f32(i32 46, float %19, float %67, float %FMad102)  ; FMad(a,b,c)
  %77 = fadd fast float %FMad101, %72
  %78 = fmul fast float %58, %.i0162
  %FMad99 = call float @dx.op.tertiary.f32(i32 46, float %.i1163453, float %63, float %78)  ; FMad(a,b,c)
  %FMad98 = call float @dx.op.tertiary.f32(i32 46, float %19, float %68, float %FMad99)  ; FMad(a,b,c)
  %79 = fadd fast float %FMad98, %73
  %80 = fmul fast float %59, %.i0162
  %FMad96 = call float @dx.op.tertiary.f32(i32 46, float %.i1163453, float %64, float %80)  ; FMad(a,b,c)
  %FMad95 = call float @dx.op.tertiary.f32(i32 46, float %19, float %69, float %FMad96)  ; FMad(a,b,c)
  %81 = fadd fast float %FMad95, %74
  %82 = fmul fast float %60, %.i0162
  %FMad93 = call float @dx.op.tertiary.f32(i32 46, float %.i1163453, float %65, float %82)  ; FMad(a,b,c)
  %FMad92 = call float @dx.op.tertiary.f32(i32 46, float %19, float %70, float %FMad93)  ; FMad(a,b,c)
  %83 = fadd fast float %FMad92, %75
  ...
  %FMad138 = call float @dx.op.tertiary.f32(i32 46, float %.i1213, float %125, float %132)  ; FMad(a,b,c)
  %FMad137 = call float @dx.op.tertiary.f32(i32 46, float %.i2214, float %129, float %FMad138)  ; FMad(a,b,c)
  %133 = fmul fast float %122, %.i0212
  %FMad136 = call float @dx.op.tertiary.f32(i32 46, float %.i1213, float %126, float %133)  ; FMad(a,b,c)
  %FMad135 = call float @dx.op.tertiary.f32(i32 46, float %.i2214, float %130, float %FMad136)  ; FMad(a,b,c)
  %134 = fmul fast float %123, %.i0212
  %FMad134 = call float @dx.op.tertiary.f32(i32 46, float %.i1213, float %127, float %134)  ; FMad(a,b,c)
  %FMad133 = call float @dx.op.tertiary.f32(i32 46, float %.i2214, float %131, float %FMad134)  ; FMad(a,b,c)
  ...
  %.i0227 = fmul fast float %.i0215, %FMad137
  %.i1228 = fmul fast float %.i0215, %FMad135
  %.i2229 = fmul fast float %.i0215, %FMad133
  ...
  %.i0237 = fmul fast float %FMad137, 4.000000e+00
  %.i1238 = fmul fast float %FMad135, 4.000000e+00
  %.i2239 = fmul fast float %FMad133, 4.000000e+00
  ...
  %FMad86 = call float @dx.op.tertiary.f32(i32 46, float %19, float %144, float 0.000000e+00)  ; FMad(a,b,c)
  %178 = fadd fast float %FMad86, %147
  %FMad80 = call float @dx.op.tertiary.f32(i32 46, float %19, float %145, float 0.000000e+00)  ; FMad(a,b,c)
  %179 = fadd fast float %FMad80, %148
  %180 = fdiv fast float 1.000000e+00, %179
  %.i1244 = fmul fast float %180, %178
  %181 = fdiv fast float 2.000000e+00, %167
  %FMad123 = call float @dx.op.tertiary.f32(i32 46, float %181, float %141, float 0.000000e+00)  ; FMad(a,b,c)
  %FMad122 = call float @dx.op.tertiary.f32(i32 46, float %19, float %144, float %FMad123)  ; FMad(a,b,c)
  %182 = fadd fast float %FMad122, %147
  %FMad117 = call float @dx.op.tertiary.f32(i32 46, float %181, float %142, float 0.000000e+00)  ; FMad(a,b,c)
  %FMad116 = call float @dx.op.tertiary.f32(i32 46, float %19, float %145, float %FMad117)  ; FMad(a,b,c)
  %183 = fadd fast float %FMad116, %148
...
._crit_edge:                                      ; preds = %.lr.ph, %.lr.ph30
  ...
  %FMad78 = call float @dx.op.tertiary.f32(i32 46, float %.i1298, float %279, float %286)  ; FMad(a,b,c)
  %FMad77 = call float @dx.op.tertiary.f32(i32 46, float %.i2299, float %283, float %FMad78)  ; FMad(a,b,c)
  %287 = insertelement <3 x float> undef, float %FMad77, i64 0
  %288 = fmul fast float %276, %.i0297
  %FMad76 = call float @dx.op.tertiary.f32(i32 46, float %.i1298, float %280, float %288)  ; FMad(a,b,c)
  %FMad75 = call float @dx.op.tertiary.f32(i32 46, float %.i2299, float %284, float %FMad76)  ; FMad(a,b,c)
  %289 = insertelement <3 x float> %287, float %FMad75, i64 1
  %290 = fmul fast float %277, %.i0297
  %FMad74 = call float @dx.op.tertiary.f32(i32 46, float %.i1298, float %281, float %290)  ; FMad(a,b,c)
  %FMad = call float @dx.op.tertiary.f32(i32 46, float %.i2299, float %285, float %FMad74)  ; FMad(a,b,c)
  %291 = insertelement <3 x float> %289, float %FMad, i64 2
  ...
  call void @dx.op.traceRay.struct.HitData(i32 157, %dx.types.Handle %295, i32 0, i32 1, i32 0, i32 2, i32 0, float %297, float %298, float %299, float %336, float %FMad77, float %FMad75, float %FMad, float %294, %struct.HitData* nonnull %12)  ; TraceRay(AccelerationStructure,RayFlags,InstanceInclusionMask,RayContributionToHitGroupIndex,MultiplierForGeometryContributionToShaderIndex,MissShaderIndex,Origin_X,Origin_Y,Origin_Z,TMin,Direction_X,Direction_Y,Direction_Z,TMax,payload)
...
; <label>:302                                     ; preds = %._crit_edge
  ...
  %.i0334 = fmul fast float %FMad77, %304
  %.i1336 = fmul fast float %FMad75, %304
  %.i2338 = fmul fast float %FMad, %304
  ...
  %FMad132 = call float @dx.op.tertiary.f32(i32 46, float %308, float %315, float %322)  ; FMad(a,b,c)
  %FMad131 = call float @dx.op.tertiary.f32(i32 46, float %309, float %319, float %FMad132)  ; FMad(a,b,c)
  %323 = insertelement <3 x float> undef, float %FMad131, i64 0
  %324 = fmul fast float %312, %307
  %FMad130 = call float @dx.op.tertiary.f32(i32 46, float %308, float %316, float %324)  ; FMad(a,b,c)
  %FMad129 = call float @dx.op.tertiary.f32(i32 46, float %309, float %320, float %FMad130)  ; FMad(a,b,c)
  %325 = insertelement <3 x float> %323, float %FMad129, i64 1
  %326 = fmul fast float %313, %307
  %FMad128 = call float @dx.op.tertiary.f32(i32 46, float %308, float %317, float %326)  ; FMad(a,b,c)
  %FMad127 = call float @dx.op.tertiary.f32(i32 46, float %309, float %321, float %FMad128)  ; FMad(a,b,c)
  %327 = insertelement <3 x float> %325, float %FMad127, i64 2
