...
"\01?internal.getWorldSpaceNoiseOffset@@YA?AV?$vector@I$01@@V?$vector@M$01@@V?$matrix@M$03$03@@10MV?$vector@M$02@@22M_N@Z.exit33":
  ...
  %FMad114 = call float @dx.op.tertiary.f32(i32 46, float %.i1163453, float %28, float %42)  ; FMad(a,b,c)
  %FMad113 = call float @dx.op.tertiary.f32(i32 46, float %19, float %33, float %FMad114)  ; FMad(a,b,c)
  %43 = fadd fast float %FMad113, %38
  %44 = fmul fast float %24, %.i0162
  %FMad111 = call float @dx.op.tertiary.f32(i32 46, float %.i1163453, float %29, float %44)  ; FMad(a,b,c)
  %FMad110 = call float @dx.op.tertiary.f32(i32 46, float %19, float %34, float %FMad111)  ; FMad(a,b,c)
  %45 = fadd fast float %FMad110, %39
  %46 = fmul fast float %25, %.i0162
  %FMad108 = call float @dx.op.tertiary.f32(i32 46, float %.i1163453, float %30, float %46)  ; FMad(a,b,c)
  %FMad107 = call float @dx.op.tertiary.f32(i32 46, float %19, float %35, float %FMad108)  ; FMad(a,b,c)
  %47 = fadd fast float %FMad107, %40
  %48 = fmul fast float %26, %.i0162
  %FMad105 = call float @dx.op.tertiary.f32(i32 46, float %.i1163453, float %31, float %48)  ; FMad(a,b,c)
  %FMad104 = call float @dx.op.tertiary.f32(i32 46, float %19, float %36, float %FMad105)  ; FMad(a,b,c)
  %49 = fadd fast float %FMad104, %41
  ...
  %FMad150 = call float @dx.op.tertiary.f32(i32 46, float %.i1163453, float %62, float %76)  ; FMad(a,b,c)
  %FMad149 = call float @dx.op.tertiary.f32(i32 46, float %19, float %67, float %FMad150)  ; FMad(a,b,c)
  %77 = fadd fast float %FMad149, %72
  %78 = fmul fast float %58, %.i0162
  %FMad147 = call float @dx.op.tertiary.f32(i32 46, float %.i1163453, float %63, float %78)  ; FMad(a,b,c)
  %FMad146 = call float @dx.op.tertiary.f32(i32 46, float %19, float %68, float %FMad147)  ; FMad(a,b,c)
  %79 = fadd fast float %FMad146, %73
  %80 = fmul fast float %59, %.i0162
  %FMad144 = call float @dx.op.tertiary.f32(i32 46, float %.i1163453, float %64, float %80)  ; FMad(a,b,c)
  %FMad143 = call float @dx.op.tertiary.f32(i32 46, float %19, float %69, float %FMad144)  ; FMad(a,b,c)
  %81 = fadd fast float %FMad143, %74
  %82 = fmul fast float %60, %.i0162
  %FMad141 = call float @dx.op.tertiary.f32(i32 46, float %.i1163453, float %65, float %82)  ; FMad(a,b,c)
  %FMad140 = call float @dx.op.tertiary.f32(i32 46, float %19, float %70, float %FMad141)  ; FMad(a,b,c)
  %83 = fadd fast float %FMad140, %75
  ...
  %FMad102 = call float @dx.op.tertiary.f32(i32 46, float %.i1213, float %126, float %133)  ; FMad(a,b,c)
  %FMad101 = call float @dx.op.tertiary.f32(i32 46, float %.i2214, float %130, float %FMad102)  ; FMad(a,b,c)
  %134 = fmul fast float %123, %.i0212
  %FMad100 = call float @dx.op.tertiary.f32(i32 46, float %.i1213, float %127, float %134)  ; FMad(a,b,c)
  %FMad99 = call float @dx.op.tertiary.f32(i32 46, float %.i2214, float %131, float %FMad100)  ; FMad(a,b,c)
  %135 = fmul fast float %124, %.i0212
  %FMad98 = call float @dx.op.tertiary.f32(i32 46, float %.i1213, float %128, float %135)  ; FMad(a,b,c)
  %FMad97 = call float @dx.op.tertiary.f32(i32 46, float %.i2214, float %132, float %FMad98)  ; FMad(a,b,c)
  ...
  %.i0227 = fmul fast float %.i0215, %FMad101
  %.i1228 = fmul fast float %.i0215, %FMad99
  %.i2229 = fmul fast float %.i0215, %FMad97
  ...
  store <3 x float> %137, <3 x float>* %138, align 4, !tbaa !530
  %139 = getelementptr inbounds %struct.RayDesc, %struct.RayDesc* %ray, i32 0, i32 1
  store float 0.000000e+00, float* %139, align 4, !tbaa !545
  ...
  %.i0237 = fmul fast float %FMad101, 4.000000e+00
  %.i1238 = fmul fast float %FMad99, 4.000000e+00
  %.i2239 = fmul fast float %FMad97, 4.000000e+00
  ...
  %FMad86 = call float @dx.op.tertiary.f32(i32 46, float %19, float %146, float 0.000000e+00)  ; FMad(a,b,c)
  %180 = fadd fast float %FMad86, %149
  %FMad80 = call float @dx.op.tertiary.f32(i32 46, float %19, float %147, float 0.000000e+00)  ; FMad(a,b,c)
  %181 = fadd fast float %FMad80, %150
  %182 = fdiv fast float 1.000000e+00, %181
  %.i1244 = fmul fast float %182, %180
  %183 = fdiv fast float 2.000000e+00, %169
  %FMad123 = call float @dx.op.tertiary.f32(i32 46, float %183, float %143, float 0.000000e+00)  ; FMad(a,b,c)
  %FMad122 = call float @dx.op.tertiary.f32(i32 46, float %19, float %146, float %FMad123)  ; FMad(a,b,c)
  %184 = fadd fast float %FMad122, %149
  %FMad117 = call float @dx.op.tertiary.f32(i32 46, float %183, float %144, float 0.000000e+00)  ; FMad(a,b,c)
  %FMad116 = call float @dx.op.tertiary.f32(i32 46, float %19, float %147, float %FMad117)  ; FMad(a,b,c)
  %185 = fadd fast float %FMad116, %150
  ...
  store i32 0, i32* %192, align 4, !tbaa !538
  ...
  %220 = load float, float* %170, align 4, !tbaa !545
  ...
  %226 = load float, float* %171, align 4, !tbaa !545
  ...
  %232 = load float, float* %172, align 4, !tbaa !545
  ...
  store float 0.000000e+00, float* %241, align 4, !tbaa !545
  ...
  %FMad138 = call float @dx.op.tertiary.f32(i32 46, float %.i1355, float %156, float %262)  ; FMad(a,b,c)
  %FMad137 = call float @dx.op.tertiary.f32(i32 46, float %.i2356, float %160, float %FMad138)  ; FMad(a,b,c)
  %263 = fadd fast float %FMad137, %164
  %264 = fmul fast float %.i0354, %153
  %FMad135 = call float @dx.op.tertiary.f32(i32 46, float %.i1355, float %157, float %264)  ; FMad(a,b,c)
  %FMad134 = call float @dx.op.tertiary.f32(i32 46, float %.i2356, float %161, float %FMad135)  ; FMad(a,b,c)
  %265 = fadd fast float %FMad134, %165
  %266 = fmul fast float %.i0354, %154
  %FMad129 = call float @dx.op.tertiary.f32(i32 46, float %.i1355, float %158, float %266)  ; FMad(a,b,c)
  %FMad128 = call float @dx.op.tertiary.f32(i32 46, float %.i2356, float %162, float %FMad129)  ; FMad(a,b,c)
  %267 = fadd fast float %FMad128, %166
...
; <label>:349                                     ; preds = %._crit_edge
  ...
  store <3 x float> %352, <3 x float>* %138, align 4, !tbaa !530
  ...
  %FMad96 = call float @dx.op.tertiary.f32(i32 46, float %355, float %362, float %369)  ; FMad(a,b,c)
  %FMad95 = call float @dx.op.tertiary.f32(i32 46, float %356, float %366, float %FMad96)  ; FMad(a,b,c)
  %370 = insertelement <3 x float> undef, float %FMad95, i64 0
  %371 = fmul fast float %359, %354
  %FMad94 = call float @dx.op.tertiary.f32(i32 46, float %355, float %363, float %371)  ; FMad(a,b,c)
  %FMad93 = call float @dx.op.tertiary.f32(i32 46, float %356, float %367, float %FMad94)  ; FMad(a,b,c)
  %372 = insertelement <3 x float> %370, float %FMad93, i64 1
  %373 = fmul fast float %360, %354
  %FMad92 = call float @dx.op.tertiary.f32(i32 46, float %355, float %364, float %373)  ; FMad(a,b,c)
  %FMad91 = call float @dx.op.tertiary.f32(i32 46, float %356, float %368, float %FMad92)  ; FMad(a,b,c)
  %374 = insertelement <3 x float> %372, float %FMad91, i64 2
  ...
  call void @dx.op.traceRay.struct.HitData(i32 157, %dx.types.Handle %375, i32 4, i32 1, i32 1, i32 2, i32 1, float %.i0340, float %.i1342, float %.i2344, float %389, float %FMad95, float %FMad93, float %FMad91, float 1.000000e+03, %struct.HitData* nonnull %11)  ; TraceRay(AccelerationStructure,RayFlags,InstanceInclusionMask,RayContributionToHitGroupIndex,MultiplierForGeometryContributionToShaderIndex,MissShaderIndex,Origin_X,Origin_Y,Origin_Z,TMin,Direction_X,Direction_Y,Direction_Z,TMax,payload)
  br label %376
