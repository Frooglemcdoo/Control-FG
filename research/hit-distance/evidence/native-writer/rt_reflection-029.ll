...
define void @"\01?reflectionRayGeneration@@YAXXZ"() #1 {
  ...
  %FMad130 = call float @dx.op.tertiary.f32(i32 46, float %.i1173487, float %32, float %46)  ; FMad(a,b,c)
  %FMad129 = call float @dx.op.tertiary.f32(i32 46, float %23, float %37, float %FMad130)  ; FMad(a,b,c)
  %47 = fadd fast float %FMad129, %42
  %48 = fmul fast float %28, %.i0172
  %FMad127 = call float @dx.op.tertiary.f32(i32 46, float %.i1173487, float %33, float %48)  ; FMad(a,b,c)
  %FMad126 = call float @dx.op.tertiary.f32(i32 46, float %23, float %38, float %FMad127)  ; FMad(a,b,c)
  %49 = fadd fast float %FMad126, %43
  %50 = fmul fast float %29, %.i0172
  %FMad124 = call float @dx.op.tertiary.f32(i32 46, float %.i1173487, float %34, float %50)  ; FMad(a,b,c)
  %FMad123 = call float @dx.op.tertiary.f32(i32 46, float %23, float %39, float %FMad124)  ; FMad(a,b,c)
  %51 = fadd fast float %FMad123, %44
  %52 = fmul fast float %30, %.i0172
  %FMad121 = call float @dx.op.tertiary.f32(i32 46, float %.i1173487, float %35, float %52)  ; FMad(a,b,c)
  %FMad120 = call float @dx.op.tertiary.f32(i32 46, float %23, float %40, float %FMad121)  ; FMad(a,b,c)
  %53 = fadd fast float %FMad120, %45
...
._crit_edge:                                      ; preds = %.lr.ph, %.lr.ph31
  ...
  %FMad118 = call float @dx.op.tertiary.f32(i32 46, float %.i1338, float %330, float %337)  ; FMad(a,b,c)
  %FMad117 = call float @dx.op.tertiary.f32(i32 46, float %.i2339, float %334, float %FMad118)  ; FMad(a,b,c)
  %338 = fmul fast float %327, %.i0337
  %FMad116 = call float @dx.op.tertiary.f32(i32 46, float %.i1338, float %331, float %338)  ; FMad(a,b,c)
  %FMad115 = call float @dx.op.tertiary.f32(i32 46, float %.i2339, float %335, float %FMad116)  ; FMad(a,b,c)
  %339 = fmul fast float %328, %.i0337
  %FMad114 = call float @dx.op.tertiary.f32(i32 46, float %.i1338, float %332, float %339)  ; FMad(a,b,c)
  %FMad113 = call float @dx.op.tertiary.f32(i32 46, float %.i2339, float %336, float %FMad114)  ; FMad(a,b,c)
  ...
  call void @dx.op.traceRay.struct.HitData(i32 157, %dx.types.Handle %343, i32 0, i32 1, i32 0, i32 2, i32 0, float %352, float %353, float %354, float %355, float %FMad117, float %FMad115, float %FMad113, float %342, %struct.HitData* nonnull %16)  ; TraceRay(AccelerationStructure,RayFlags,InstanceInclusionMask,RayContributionToHitGroupIndex,MultiplierForGeometryContributionToShaderIndex,MissShaderIndex,Origin_X,Origin_Y,Origin_Z,TMin,Direction_X,Direction_Y,Direction_Z,TMax,payload)
...
._crit_edge.32.loopexit:                          ; preds = %._crit_edge
  ...
  %FMad115.lcssa = phi float [ %FMad115, %._crit_edge ]
  %FMad117.lcssa = phi float [ %FMad117, %._crit_edge ]
  %345 = getelementptr inbounds %struct.RayDesc, %struct.RayDesc* %ray, i32 0, i32 3
  %346 = insertelement <3 x float> undef, float %FMad117.lcssa, i64 0
  %347 = insertelement <3 x float> %346, float %FMad115.lcssa, i64 1
  %348 = insertelement <3 x float> %347, float %FMad113.lcssa, i64 2
