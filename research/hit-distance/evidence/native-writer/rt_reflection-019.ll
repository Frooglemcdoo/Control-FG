...
define void @"\01?reflectionRayGeneration@@YAXXZ"() #1 {
  ...
  %FMad154 = call float @dx.op.tertiary.f32(i32 46, float %.i1180508, float %34, float %48)  ; FMad(a,b,c)
  %FMad153 = call float @dx.op.tertiary.f32(i32 46, float %25, float %39, float %FMad154)  ; FMad(a,b,c)
  %49 = fadd fast float %FMad153, %44
  %50 = fmul fast float %30, %.i0179
  %FMad151 = call float @dx.op.tertiary.f32(i32 46, float %.i1180508, float %35, float %50)  ; FMad(a,b,c)
  %FMad150 = call float @dx.op.tertiary.f32(i32 46, float %25, float %40, float %FMad151)  ; FMad(a,b,c)
  %51 = fadd fast float %FMad150, %45
  %52 = fmul fast float %31, %.i0179
  %FMad148 = call float @dx.op.tertiary.f32(i32 46, float %.i1180508, float %36, float %52)  ; FMad(a,b,c)
  %FMad147 = call float @dx.op.tertiary.f32(i32 46, float %25, float %41, float %FMad148)  ; FMad(a,b,c)
  %53 = fadd fast float %FMad147, %46
  %54 = fmul fast float %32, %.i0179
  %FMad145 = call float @dx.op.tertiary.f32(i32 46, float %.i1180508, float %37, float %54)  ; FMad(a,b,c)
  %FMad144 = call float @dx.op.tertiary.f32(i32 46, float %25, float %42, float %FMad145)  ; FMad(a,b,c)
  %55 = fadd fast float %FMad144, %47
  ...
  %FMad142 = call float @dx.op.tertiary.f32(i32 46, float %.i1180508, float %68, float %82)  ; FMad(a,b,c)
  %FMad141 = call float @dx.op.tertiary.f32(i32 46, float %25, float %73, float %FMad142)  ; FMad(a,b,c)
  %83 = fadd fast float %FMad141, %78
  %84 = fmul fast float %64, %.i0179
  %FMad139 = call float @dx.op.tertiary.f32(i32 46, float %.i1180508, float %69, float %84)  ; FMad(a,b,c)
  %FMad138 = call float @dx.op.tertiary.f32(i32 46, float %25, float %74, float %FMad139)  ; FMad(a,b,c)
  %85 = fadd fast float %FMad138, %79
  %86 = fmul fast float %65, %.i0179
  %FMad136 = call float @dx.op.tertiary.f32(i32 46, float %.i1180508, float %70, float %86)  ; FMad(a,b,c)
  %FMad135 = call float @dx.op.tertiary.f32(i32 46, float %25, float %75, float %FMad136)  ; FMad(a,b,c)
  %87 = fadd fast float %FMad135, %80
  %88 = fmul fast float %66, %.i0179
  %FMad133 = call float @dx.op.tertiary.f32(i32 46, float %.i1180508, float %71, float %88)  ; FMad(a,b,c)
  %FMad132 = call float @dx.op.tertiary.f32(i32 46, float %25, float %76, float %FMad133)  ; FMad(a,b,c)
  %89 = fadd fast float %FMad132, %81
...
"\01?internal.getReflectionRayCount@@YAHV?$vector@M$02@@M@Z.exit": ; preds = %193, %"\01?internal.getMaterialSpecular@@YA?AV?$vector@M$02@@IM@Z.exit"
  ...
  %FMad108 = call float @dx.op.tertiary.f32(i32 46, float %25, float %205, float 0.000000e+00)  ; FMad(a,b,c)
  %239 = fadd fast float %FMad108, %208
  %FMad102 = call float @dx.op.tertiary.f32(i32 46, float %25, float %206, float 0.000000e+00)  ; FMad(a,b,c)
  %240 = fadd fast float %FMad102, %209
  %241 = fdiv fast float 1.000000e+00, %240
  %.i1291 = fmul fast float %241, %239
  %242 = fdiv fast float 2.000000e+00, %228
  %FMad97 = call float @dx.op.tertiary.f32(i32 46, float %242, float %202, float 0.000000e+00)  ; FMad(a,b,c)
  %FMad96 = call float @dx.op.tertiary.f32(i32 46, float %25, float %205, float %FMad97)  ; FMad(a,b,c)
  %243 = fadd fast float %FMad96, %208
  %FMad91 = call float @dx.op.tertiary.f32(i32 46, float %242, float %203, float 0.000000e+00)  ; FMad(a,b,c)
  %FMad90 = call float @dx.op.tertiary.f32(i32 46, float %25, float %206, float %FMad91)  ; FMad(a,b,c)
  %244 = fadd fast float %FMad90, %209
  ...
  %FMad130 = call float @dx.op.tertiary.f32(i32 46, float %.i1402, float %215, float %321)  ; FMad(a,b,c)
  %FMad129 = call float @dx.op.tertiary.f32(i32 46, float %.i2403, float %219, float %FMad130)  ; FMad(a,b,c)
  %322 = fadd fast float %FMad129, %223
  %323 = fmul fast float %.i0401, %212
  %FMad127 = call float @dx.op.tertiary.f32(i32 46, float %.i1402, float %216, float %323)  ; FMad(a,b,c)
  %FMad126 = call float @dx.op.tertiary.f32(i32 46, float %.i2403, float %220, float %FMad127)  ; FMad(a,b,c)
  %324 = fadd fast float %FMad126, %224
  %325 = fmul fast float %.i0401, %213
  %FMad121 = call float @dx.op.tertiary.f32(i32 46, float %.i1402, float %217, float %325)  ; FMad(a,b,c)
  %FMad120 = call float @dx.op.tertiary.f32(i32 46, float %.i2403, float %221, float %FMad121)  ; FMad(a,b,c)
  %326 = fadd fast float %FMad120, %225
...
._crit_edge:                                      ; preds = %._crit_edge.loopexit, %"\01?internal.getImportanceRay@@YA?AV?$vector@M$02@@V1@0MV?$vector@M$01@@@Z.exit"
  ...
  %FMad118 = call float @dx.op.tertiary.f32(i32 46, float %vReflectionDirectionInView.0.lcssa.i1, float %385, float %392)  ; FMad(a,b,c)
  %FMad117 = call float @dx.op.tertiary.f32(i32 46, float %vReflectionDirectionInView.0.lcssa.i2, float %389, float %FMad118)  ; FMad(a,b,c)
  %393 = insertelement <3 x float> undef, float %FMad117, i64 0
  %394 = fmul fast float %382, %vReflectionDirectionInView.0.lcssa.i0
  %FMad116 = call float @dx.op.tertiary.f32(i32 46, float %vReflectionDirectionInView.0.lcssa.i1, float %386, float %394)  ; FMad(a,b,c)
  %FMad115 = call float @dx.op.tertiary.f32(i32 46, float %vReflectionDirectionInView.0.lcssa.i2, float %390, float %FMad116)  ; FMad(a,b,c)
  %395 = insertelement <3 x float> %393, float %FMad115, i64 1
  %396 = fmul fast float %383, %vReflectionDirectionInView.0.lcssa.i0
  %FMad114 = call float @dx.op.tertiary.f32(i32 46, float %vReflectionDirectionInView.0.lcssa.i1, float %387, float %396)  ; FMad(a,b,c)
  %FMad113 = call float @dx.op.tertiary.f32(i32 46, float %vReflectionDirectionInView.0.lcssa.i2, float %391, float %FMad114)  ; FMad(a,b,c)
  %397 = insertelement <3 x float> %395, float %FMad113, i64 2
  ...
  call void @dx.op.traceRay.struct.HitData(i32 157, %dx.types.Handle %401, i32 0, i32 1, i32 0, i32 2, i32 0, float %403, float %404, float %405, float %448, float %FMad117, float %FMad115, float %FMad113, float %400, %struct.HitData* nonnull %18)  ; TraceRay(AccelerationStructure,RayFlags,InstanceInclusionMask,RayContributionToHitGroupIndex,MultiplierForGeometryContributionToShaderIndex,MissShaderIndex,Origin_X,Origin_Y,Origin_Z,TMin,Direction_X,Direction_Y,Direction_Z,TMax,payload)
...
; <label>:408                                     ; preds = %._crit_edge
  ...
  %.i0381 = fmul fast float %FMad117, %410
  %.i1383 = fmul fast float %FMad115, %410
  %.i2385 = fmul fast float %FMad113, %410
  ...
  %FMad88 = call float @dx.op.tertiary.f32(i32 46, float %414, float %421, float %428)  ; FMad(a,b,c)
  %FMad87 = call float @dx.op.tertiary.f32(i32 46, float %415, float %425, float %FMad88)  ; FMad(a,b,c)
  %429 = insertelement <3 x float> undef, float %FMad87, i64 0
  %430 = fmul fast float %418, %413
  %FMad86 = call float @dx.op.tertiary.f32(i32 46, float %414, float %422, float %430)  ; FMad(a,b,c)
  %FMad85 = call float @dx.op.tertiary.f32(i32 46, float %415, float %426, float %FMad86)  ; FMad(a,b,c)
  %431 = insertelement <3 x float> %429, float %FMad85, i64 1
  %432 = fmul fast float %419, %413
  %FMad84 = call float @dx.op.tertiary.f32(i32 46, float %414, float %423, float %432)  ; FMad(a,b,c)
  %FMad = call float @dx.op.tertiary.f32(i32 46, float %415, float %427, float %FMad84)  ; FMad(a,b,c)
  %433 = insertelement <3 x float> %431, float %FMad, i64 2
  ...
  call void @dx.op.traceRay.struct.HitData(i32 157, %dx.types.Handle %434, i32 4, i32 1, i32 1, i32 2, i32 1, float %.i0387, float %.i1389, float %.i2391, float %448, float %FMad87, float %FMad85, float %FMad, float 1.000000e+03, %struct.HitData* nonnull %17)  ; TraceRay(AccelerationStructure,RayFlags,InstanceInclusionMask,RayContributionToHitGroupIndex,MultiplierForGeometryContributionToShaderIndex,MissShaderIndex,Origin_X,Origin_Y,Origin_Z,TMin,Direction_X,Direction_Y,Direction_Z,TMax,payload)
  br label %435
