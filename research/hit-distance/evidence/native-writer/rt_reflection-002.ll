...
"\01?internal.getRaytracingVertexIndices@@YA?AV?$vector@I$02@@I@Z.exit": ; preds = %35, %22
  ...
  %126 = load i32, i32* %125, align 4, !tbaa !536
  ...
  store i32 %131, i32* %125, align 4, !tbaa !536
  ret void
}
...
"\01?internal.getWorldSpaceNoiseOffset@@YA?AV?$vector@I$01@@V?$vector@M$01@@V?$matrix@M$03$03@@10MV?$vector@M$02@@22M_N@Z.exit33":
  ...
  %FMad150 = call float @dx.op.tertiary.f32(i32 46, float %.i1163453, float %28, float %42)  ; FMad(a,b,c)
  %FMad149 = call float @dx.op.tertiary.f32(i32 46, float %19, float %33, float %FMad150)  ; FMad(a,b,c)
  %43 = fadd fast float %FMad149, %38
  %44 = fmul fast float %24, %.i0162
  %FMad147 = call float @dx.op.tertiary.f32(i32 46, float %.i1163453, float %29, float %44)  ; FMad(a,b,c)
  %FMad146 = call float @dx.op.tertiary.f32(i32 46, float %19, float %34, float %FMad147)  ; FMad(a,b,c)
  %45 = fadd fast float %FMad146, %39
  %46 = fmul fast float %25, %.i0162
  %FMad144 = call float @dx.op.tertiary.f32(i32 46, float %.i1163453, float %30, float %46)  ; FMad(a,b,c)
  %FMad143 = call float @dx.op.tertiary.f32(i32 46, float %19, float %35, float %FMad144)  ; FMad(a,b,c)
  %47 = fadd fast float %FMad143, %40
  %48 = fmul fast float %26, %.i0162
  %FMad141 = call float @dx.op.tertiary.f32(i32 46, float %.i1163453, float %31, float %48)  ; FMad(a,b,c)
  %FMad140 = call float @dx.op.tertiary.f32(i32 46, float %19, float %36, float %FMad141)  ; FMad(a,b,c)
  %49 = fadd fast float %FMad140, %41
  ...
  %FMad120 = call float @dx.op.tertiary.f32(i32 46, float %.i1213, float %126, float %133)  ; FMad(a,b,c)
  %FMad119 = call float @dx.op.tertiary.f32(i32 46, float %.i2214, float %130, float %FMad120)  ; FMad(a,b,c)
  %134 = fmul fast float %123, %.i0212
  %FMad118 = call float @dx.op.tertiary.f32(i32 46, float %.i1213, float %127, float %134)  ; FMad(a,b,c)
  %FMad117 = call float @dx.op.tertiary.f32(i32 46, float %.i2214, float %131, float %FMad118)  ; FMad(a,b,c)
  %135 = fmul fast float %124, %.i0212
  %FMad116 = call float @dx.op.tertiary.f32(i32 46, float %.i1213, float %128, float %135)  ; FMad(a,b,c)
  %FMad115 = call float @dx.op.tertiary.f32(i32 46, float %.i2214, float %132, float %FMad116)  ; FMad(a,b,c)
  ...
  store <3 x float> %137, <3 x float>* %138, align 4, !tbaa !528
  %139 = getelementptr inbounds %struct.RayDesc, %struct.RayDesc* %ray, i32 0, i32 1
  store float 0.000000e+00, float* %139, align 4, !tbaa !543
  ...
  %FMad129 = call float @dx.op.tertiary.f32(i32 46, float %183, float %143, float 0.000000e+00)  ; FMad(a,b,c)
  %FMad128 = call float @dx.op.tertiary.f32(i32 46, float %19, float %146, float %FMad129)  ; FMad(a,b,c)
  %184 = fadd fast float %FMad128, %149
  %FMad123 = call float @dx.op.tertiary.f32(i32 46, float %183, float %144, float 0.000000e+00)  ; FMad(a,b,c)
  %FMad122 = call float @dx.op.tertiary.f32(i32 46, float %19, float %147, float %FMad123)  ; FMad(a,b,c)
  %185 = fadd fast float %FMad122, %150
  ...
  store i32 0, i32* %192, align 4, !tbaa !536
  ...
  %220 = load float, float* %170, align 4, !tbaa !543
  ...
  %226 = load float, float* %171, align 4, !tbaa !543
  ...
  %232 = load float, float* %172, align 4, !tbaa !543
  ...
  store float 0.000000e+00, float* %241, align 4, !tbaa !543
  ...
  %FMad84 = call float @dx.op.tertiary.f32(i32 46, float %.i1355, float %156, float %262)  ; FMad(a,b,c)
  %FMad83 = call float @dx.op.tertiary.f32(i32 46, float %.i2356, float %160, float %FMad84)  ; FMad(a,b,c)
  %263 = fadd fast float %FMad83, %164
  %264 = fmul fast float %.i0354, %153
  %FMad81 = call float @dx.op.tertiary.f32(i32 46, float %.i1355, float %157, float %264)  ; FMad(a,b,c)
  %FMad80 = call float @dx.op.tertiary.f32(i32 46, float %.i2356, float %161, float %FMad81)  ; FMad(a,b,c)
  %265 = fadd fast float %FMad80, %165
  %266 = fmul fast float %.i0354, %154
  %FMad75 = call float @dx.op.tertiary.f32(i32 46, float %.i1355, float %158, float %266)  ; FMad(a,b,c)
  %FMad74 = call float @dx.op.tertiary.f32(i32 46, float %.i2356, float %162, float %FMad75)  ; FMad(a,b,c)
  %267 = fadd fast float %FMad74, %166
...
._crit_edge:                                      ; preds = %._crit_edge.loopexit, %"\01?internal.getImportanceRay@@YA?AV?$vector@M$02@@V1@0MV?$vector@M$01@@@Z.exit"
  ...
  %FMad138 = call float @dx.op.tertiary.f32(i32 46, float %vReflectionDirectionInView.0.lcssa.i1, float %326, float %333)  ; FMad(a,b,c)
  %FMad137 = call float @dx.op.tertiary.f32(i32 46, float %vReflectionDirectionInView.0.lcssa.i2, float %330, float %FMad138)  ; FMad(a,b,c)
  %334 = insertelement <3 x float> undef, float %FMad137, i64 0
  %335 = fmul fast float %323, %vReflectionDirectionInView.0.lcssa.i0
  %FMad136 = call float @dx.op.tertiary.f32(i32 46, float %vReflectionDirectionInView.0.lcssa.i1, float %327, float %335)  ; FMad(a,b,c)
  %FMad135 = call float @dx.op.tertiary.f32(i32 46, float %vReflectionDirectionInView.0.lcssa.i2, float %331, float %FMad136)  ; FMad(a,b,c)
  %336 = insertelement <3 x float> %334, float %FMad135, i64 1
  %337 = fmul fast float %324, %vReflectionDirectionInView.0.lcssa.i0
  %FMad134 = call float @dx.op.tertiary.f32(i32 46, float %vReflectionDirectionInView.0.lcssa.i1, float %328, float %337)  ; FMad(a,b,c)
  %FMad133 = call float @dx.op.tertiary.f32(i32 46, float %vReflectionDirectionInView.0.lcssa.i2, float %332, float %FMad134)  ; FMad(a,b,c)
  %338 = insertelement <3 x float> %336, float %FMad133, i64 2
  ...
  call void @dx.op.traceRay.struct.HitData(i32 157, %dx.types.Handle %342, i32 0, i32 1, i32 0, i32 2, i32 0, float %344, float %345, float %346, float %389, float %FMad137, float %FMad135, float %FMad133, float %341, %struct.HitData* nonnull %12)  ; TraceRay(AccelerationStructure,RayFlags,InstanceInclusionMask,RayContributionToHitGroupIndex,MultiplierForGeometryContributionToShaderIndex,MissShaderIndex,Origin_X,Origin_Y,Origin_Z,TMin,Direction_X,Direction_Y,Direction_Z,TMax,payload)
...
; <label>:349                                     ; preds = %._crit_edge
  ...
  %.i0334 = fmul fast float %FMad137, %351
  %.i1336 = fmul fast float %FMad135, %351
  %.i2338 = fmul fast float %FMad133, %351
  ...
  store <3 x float> %352, <3 x float>* %138, align 4, !tbaa !528
  ...
  %FMad102 = call float @dx.op.tertiary.f32(i32 46, float %355, float %362, float %369)  ; FMad(a,b,c)
  %FMad101 = call float @dx.op.tertiary.f32(i32 46, float %356, float %366, float %FMad102)  ; FMad(a,b,c)
  %370 = insertelement <3 x float> undef, float %FMad101, i64 0
  %371 = fmul fast float %359, %354
  %FMad100 = call float @dx.op.tertiary.f32(i32 46, float %355, float %363, float %371)  ; FMad(a,b,c)
  %FMad99 = call float @dx.op.tertiary.f32(i32 46, float %356, float %367, float %FMad100)  ; FMad(a,b,c)
  %372 = insertelement <3 x float> %370, float %FMad99, i64 1
  %373 = fmul fast float %360, %354
  %FMad98 = call float @dx.op.tertiary.f32(i32 46, float %355, float %364, float %373)  ; FMad(a,b,c)
  %FMad97 = call float @dx.op.tertiary.f32(i32 46, float %356, float %368, float %FMad98)  ; FMad(a,b,c)
  %374 = insertelement <3 x float> %372, float %FMad97, i64 2
  ...
  call void @dx.op.traceRay.struct.HitData(i32 157, %dx.types.Handle %375, i32 4, i32 1, i32 1, i32 2, i32 1, float %.i0340, float %.i1342, float %.i2344, float %389, float %FMad101, float %FMad99, float %FMad97, float 1.000000e+03, %struct.HitData* nonnull %11)  ; TraceRay(AccelerationStructure,RayFlags,InstanceInclusionMask,RayContributionToHitGroupIndex,MultiplierForGeometryContributionToShaderIndex,MissShaderIndex,Origin_X,Origin_Y,Origin_Z,TMin,Direction_X,Direction_Y,Direction_Z,TMax,payload)
  br label %376
...
!24 = !{i32 3, %"class.RWTexture2DArray<unsigned int>"* @"\01?g_rwtShadow@@3V?$RWTexture2DArray@I@@A", !"g_rwtShadow", i32 0, i32 3, i32 1, i32 7, i1 false, i1 false, i1 false, !21}
!25 = !{!26, !27, !28}
