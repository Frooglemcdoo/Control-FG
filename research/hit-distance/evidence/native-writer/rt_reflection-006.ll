...
"\01?internal.getWorldSpaceNoiseOffset@@YA?AV?$vector@I$01@@V?$vector@M$01@@V?$matrix@M$03$03@@10MV?$vector@M$02@@22M_N@Z.exit33":
  ...
  %FMad102 = call float @dx.op.tertiary.f32(i32 46, float %.i1163453, float %28, float %42)  ; FMad(a,b,c)
  %FMad101 = call float @dx.op.tertiary.f32(i32 46, float %19, float %33, float %FMad102)  ; FMad(a,b,c)
  %43 = fadd fast float %FMad101, %38
  %44 = fmul fast float %24, %.i0162
  %FMad99 = call float @dx.op.tertiary.f32(i32 46, float %.i1163453, float %29, float %44)  ; FMad(a,b,c)
  %FMad98 = call float @dx.op.tertiary.f32(i32 46, float %19, float %34, float %FMad99)  ; FMad(a,b,c)
  %45 = fadd fast float %FMad98, %39
  %46 = fmul fast float %25, %.i0162
  %FMad96 = call float @dx.op.tertiary.f32(i32 46, float %.i1163453, float %30, float %46)  ; FMad(a,b,c)
  %FMad95 = call float @dx.op.tertiary.f32(i32 46, float %19, float %35, float %FMad96)  ; FMad(a,b,c)
  %47 = fadd fast float %FMad95, %40
  %48 = fmul fast float %26, %.i0162
  %FMad93 = call float @dx.op.tertiary.f32(i32 46, float %.i1163453, float %31, float %48)  ; FMad(a,b,c)
  %FMad92 = call float @dx.op.tertiary.f32(i32 46, float %19, float %36, float %FMad93)  ; FMad(a,b,c)
  %49 = fadd fast float %FMad92, %41
  ...
  %FMad108 = call float @dx.op.tertiary.f32(i32 46, float %.i1213, float %125, float %132)  ; FMad(a,b,c)
  %FMad107 = call float @dx.op.tertiary.f32(i32 46, float %.i2214, float %129, float %FMad108)  ; FMad(a,b,c)
  %133 = fmul fast float %122, %.i0212
  %FMad106 = call float @dx.op.tertiary.f32(i32 46, float %.i1213, float %126, float %133)  ; FMad(a,b,c)
  %FMad105 = call float @dx.op.tertiary.f32(i32 46, float %.i2214, float %130, float %FMad106)  ; FMad(a,b,c)
  %134 = fmul fast float %123, %.i0212
  %FMad104 = call float @dx.op.tertiary.f32(i32 46, float %.i1213, float %127, float %134)  ; FMad(a,b,c)
  %FMad103 = call float @dx.op.tertiary.f32(i32 46, float %.i2214, float %131, float %FMad104)  ; FMad(a,b,c)
  ...
  %.i0227 = fmul fast float %.i0215, %FMad107
  %.i1228 = fmul fast float %.i0215, %FMad105
  %.i2229 = fmul fast float %.i0215, %FMad103
  ...
  %.i0237 = fmul fast float %FMad107, 4.000000e+00
  %.i1238 = fmul fast float %FMad105, 4.000000e+00
  %.i2239 = fmul fast float %FMad103, 4.000000e+00
  ...
  %FMad140 = call float @dx.op.tertiary.f32(i32 46, float %19, float %144, float 0.000000e+00)  ; FMad(a,b,c)
  %178 = fadd fast float %FMad140, %147
  %FMad134 = call float @dx.op.tertiary.f32(i32 46, float %19, float %145, float 0.000000e+00)  ; FMad(a,b,c)
  %179 = fadd fast float %FMad134, %148
  %180 = fdiv fast float 1.000000e+00, %179
  %.i1244 = fmul fast float %180, %178
  %181 = fdiv fast float 2.000000e+00, %167
  %FMad117 = call float @dx.op.tertiary.f32(i32 46, float %181, float %141, float 0.000000e+00)  ; FMad(a,b,c)
  %FMad116 = call float @dx.op.tertiary.f32(i32 46, float %19, float %144, float %FMad117)  ; FMad(a,b,c)
  %182 = fadd fast float %FMad116, %147
  %FMad111 = call float @dx.op.tertiary.f32(i32 46, float %181, float %142, float 0.000000e+00)  ; FMad(a,b,c)
  %FMad110 = call float @dx.op.tertiary.f32(i32 46, float %19, float %145, float %FMad111)  ; FMad(a,b,c)
  %183 = fadd fast float %FMad110, %148
  ...
  %FMad90 = call float @dx.op.tertiary.f32(i32 46, float %.i1355, float %154, float %260)  ; FMad(a,b,c)
  %FMad89 = call float @dx.op.tertiary.f32(i32 46, float %.i2356, float %158, float %FMad90)  ; FMad(a,b,c)
  %261 = fadd fast float %FMad89, %162
  %262 = fmul fast float %.i0354, %151
  %FMad87 = call float @dx.op.tertiary.f32(i32 46, float %.i1355, float %155, float %262)  ; FMad(a,b,c)
  %FMad86 = call float @dx.op.tertiary.f32(i32 46, float %.i2356, float %159, float %FMad87)  ; FMad(a,b,c)
  %263 = fadd fast float %FMad86, %163
  %264 = fmul fast float %.i0354, %152
  %FMad81 = call float @dx.op.tertiary.f32(i32 46, float %.i1355, float %156, float %264)  ; FMad(a,b,c)
  %FMad80 = call float @dx.op.tertiary.f32(i32 46, float %.i2356, float %160, float %FMad81)  ; FMad(a,b,c)
  %265 = fadd fast float %FMad80, %164
...
; <label>:302                                     ; preds = %._crit_edge
  ...
  store <3 x float> %305, <3 x float>* %136, align 4, !tbaa !528
