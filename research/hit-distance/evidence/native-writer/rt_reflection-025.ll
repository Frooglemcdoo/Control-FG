...
define void @"\01?reflectionRayGeneration@@YAXXZ"() #1 {
  ...
  %FMad112 = call float @dx.op.tertiary.f32(i32 46, float %.i1173487, float %66, float %80)  ; FMad(a,b,c)
  %FMad111 = call float @dx.op.tertiary.f32(i32 46, float %23, float %71, float %FMad112)  ; FMad(a,b,c)
  %81 = fadd fast float %FMad111, %76
  %82 = fmul fast float %62, %.i0172
  %FMad109 = call float @dx.op.tertiary.f32(i32 46, float %.i1173487, float %67, float %82)  ; FMad(a,b,c)
  %FMad108 = call float @dx.op.tertiary.f32(i32 46, float %23, float %72, float %FMad109)  ; FMad(a,b,c)
  %83 = fadd fast float %FMad108, %77
  %84 = fmul fast float %63, %.i0172
  %FMad106 = call float @dx.op.tertiary.f32(i32 46, float %.i1173487, float %68, float %84)  ; FMad(a,b,c)
  %FMad105 = call float @dx.op.tertiary.f32(i32 46, float %23, float %73, float %FMad106)  ; FMad(a,b,c)
  %85 = fadd fast float %FMad105, %78
  %86 = fmul fast float %64, %.i0172
  %FMad103 = call float @dx.op.tertiary.f32(i32 46, float %.i1173487, float %69, float %86)  ; FMad(a,b,c)
  %FMad102 = call float @dx.op.tertiary.f32(i32 46, float %23, float %74, float %FMad103)  ; FMad(a,b,c)
  %87 = fadd fast float %FMad102, %79
...
"\01?internal.getReflectionRayCount@@YAHV?$vector@M$02@@M@Z.exit": ; preds = %191, %"\01?internal.getMaterialSpecular@@YA?AV?$vector@M$02@@IM@Z.exit"
  ...
  %FMad90 = call float @dx.op.tertiary.f32(i32 46, float %23, float %203, float 0.000000e+00)  ; FMad(a,b,c)
  %237 = fadd fast float %FMad90, %206
  %FMad84 = call float @dx.op.tertiary.f32(i32 46, float %23, float %204, float 0.000000e+00)  ; FMad(a,b,c)
  %238 = fadd fast float %FMad84, %207
  ...
  %FMad136 = call float @dx.op.tertiary.f32(i32 46, float %.i1383, float %213, float %319)  ; FMad(a,b,c)
  %FMad135 = call float @dx.op.tertiary.f32(i32 46, float %.i2384, float %217, float %FMad136)  ; FMad(a,b,c)
  %320 = fadd fast float %FMad135, %221
  %321 = fmul fast float %.i0382, %210
  %FMad133 = call float @dx.op.tertiary.f32(i32 46, float %.i1383, float %214, float %321)  ; FMad(a,b,c)
  %FMad132 = call float @dx.op.tertiary.f32(i32 46, float %.i2384, float %218, float %FMad133)  ; FMad(a,b,c)
  %322 = fadd fast float %FMad132, %222
  %323 = fmul fast float %.i0382, %211
  %FMad127 = call float @dx.op.tertiary.f32(i32 46, float %.i1383, float %215, float %323)  ; FMad(a,b,c)
  %FMad126 = call float @dx.op.tertiary.f32(i32 46, float %.i2384, float %219, float %FMad127)  ; FMad(a,b,c)
  %324 = fadd fast float %FMad126, %223
...
._crit_edge:                                      ; preds = %._crit_edge.loopexit, %"\01?internal.getImportanceRay@@YA?AV?$vector@M$02@@V1@0MV?$vector@M$01@@@Z.exit13"
  ...
  %FMad100 = call float @dx.op.tertiary.f32(i32 46, float %vReflectionDirectionInView.0.lcssa.i1, float %383, float %390)  ; FMad(a,b,c)
  %FMad99 = call float @dx.op.tertiary.f32(i32 46, float %vReflectionDirectionInView.0.lcssa.i2, float %387, float %FMad100)  ; FMad(a,b,c)
  %391 = fmul fast float %380, %vReflectionDirectionInView.0.lcssa.i0
  %FMad98 = call float @dx.op.tertiary.f32(i32 46, float %vReflectionDirectionInView.0.lcssa.i1, float %384, float %391)  ; FMad(a,b,c)
  %FMad97 = call float @dx.op.tertiary.f32(i32 46, float %vReflectionDirectionInView.0.lcssa.i2, float %388, float %FMad98)  ; FMad(a,b,c)
  %392 = fmul fast float %381, %vReflectionDirectionInView.0.lcssa.i0
  %FMad96 = call float @dx.op.tertiary.f32(i32 46, float %vReflectionDirectionInView.0.lcssa.i1, float %385, float %392)  ; FMad(a,b,c)
  %FMad95 = call float @dx.op.tertiary.f32(i32 46, float %vReflectionDirectionInView.0.lcssa.i2, float %389, float %FMad96)  ; FMad(a,b,c)
  ...
  call void @dx.op.traceRay.struct.HitData(i32 157, %dx.types.Handle %396, i32 0, i32 1, i32 0, i32 2, i32 0, float %411, float %412, float %413, float %414, float %FMad99, float %FMad97, float %FMad95, float %395, %struct.HitData* nonnull %16)  ; TraceRay(AccelerationStructure,RayFlags,InstanceInclusionMask,RayContributionToHitGroupIndex,MultiplierForGeometryContributionToShaderIndex,MissShaderIndex,Origin_X,Origin_Y,Origin_Z,TMin,Direction_X,Direction_Y,Direction_Z,TMax,payload)
...
._crit_edge.32.loopexit:                          ; preds = %._crit_edge
  ...
  %400 = insertelement <3 x float> undef, float %FMad99.lcssa, i64 0
  %401 = insertelement <3 x float> %400, float %FMad97.lcssa, i64 1
  %402 = insertelement <3 x float> %401, float %FMad95.lcssa, i64 2
