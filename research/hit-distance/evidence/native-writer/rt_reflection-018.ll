...
define void @"\01?reflectionRayGeneration@@YAXXZ"() #0 {
  ...
  %FMad88 = call float @dx.op.tertiary.f32(i32 46, float %.i1230, float %132, float %139)  ; FMad(a,b,c)
  %FMad87 = call float @dx.op.tertiary.f32(i32 46, float %.i2231, float %136, float %FMad88)  ; FMad(a,b,c)
  %140 = fmul fast float %129, %.i0229
  %FMad86 = call float @dx.op.tertiary.f32(i32 46, float %.i1230, float %133, float %140)  ; FMad(a,b,c)
  %FMad85 = call float @dx.op.tertiary.f32(i32 46, float %.i2231, float %137, float %FMad86)  ; FMad(a,b,c)
  %141 = fmul fast float %130, %.i0229
  %FMad84 = call float @dx.op.tertiary.f32(i32 46, float %.i1230, float %134, float %141)  ; FMad(a,b,c)
  %FMad = call float @dx.op.tertiary.f32(i32 46, float %.i2231, float %138, float %FMad84)  ; FMad(a,b,c)
  ...
  store <3 x float> %143, <3 x float>* %144, align 4, !tbaa !533
  %145 = getelementptr inbounds %struct.RayDesc, %struct.RayDesc* %ray, i32 0, i32 1
  store float 0.000000e+00, float* %145, align 4, !tbaa !548
...
"\01?internal.getMaterialSpecular@@YA?AV?$vector@M$02@@IM@Z.exit": ; preds = %168, %0
  ...
  %173 = call float @dx.op.dot3.f32(i32 55, float %FMad87, float %FMad85, float %FMad, float %.i0268, float %.i1269, float %.i2270)  ; Dot3(ax,ay,az,bx,by,bz)
...
"\01?internal.getReflectionRayCount@@YAHV?$vector@M$02@@M@Z.exit": ; preds = %193, %"\01?internal.getMaterialSpecular@@YA?AV?$vector@M$02@@IM@Z.exit"
  ...
  %FMad144 = call float @dx.op.tertiary.f32(i32 46, float %25, float %205, float 0.000000e+00)  ; FMad(a,b,c)
  %239 = fadd fast float %FMad144, %208
  %FMad138 = call float @dx.op.tertiary.f32(i32 46, float %25, float %206, float 0.000000e+00)  ; FMad(a,b,c)
  %240 = fadd fast float %FMad138, %209
  %241 = fdiv fast float 1.000000e+00, %240
  %.i1291 = fmul fast float %241, %239
  %242 = fdiv fast float 2.000000e+00, %228
  %FMad121 = call float @dx.op.tertiary.f32(i32 46, float %242, float %202, float 0.000000e+00)  ; FMad(a,b,c)
  %FMad120 = call float @dx.op.tertiary.f32(i32 46, float %25, float %205, float %FMad121)  ; FMad(a,b,c)
  %243 = fadd fast float %FMad120, %208
  %FMad115 = call float @dx.op.tertiary.f32(i32 46, float %242, float %203, float 0.000000e+00)  ; FMad(a,b,c)
  %FMad114 = call float @dx.op.tertiary.f32(i32 46, float %25, float %206, float %FMad115)  ; FMad(a,b,c)
  %244 = fadd fast float %FMad114, %209
  ...
  store i32 0, i32* %251, align 4, !tbaa !541
  ...
  %279 = load float, float* %229, align 4, !tbaa !548
  ...
  %285 = load float, float* %230, align 4, !tbaa !548
  ...
  %291 = load float, float* %231, align 4, !tbaa !548
  ...
  store float 0.000000e+00, float* %300, align 4, !tbaa !548
  ...
  %FMad136 = call float @dx.op.tertiary.f32(i32 46, float %.i1402, float %215, float %321)  ; FMad(a,b,c)
  %FMad135 = call float @dx.op.tertiary.f32(i32 46, float %.i2403, float %219, float %FMad136)  ; FMad(a,b,c)
  %322 = fadd fast float %FMad135, %223
  %323 = fmul fast float %.i0401, %212
  %FMad133 = call float @dx.op.tertiary.f32(i32 46, float %.i1402, float %216, float %323)  ; FMad(a,b,c)
  %FMad132 = call float @dx.op.tertiary.f32(i32 46, float %.i2403, float %220, float %FMad133)  ; FMad(a,b,c)
  %324 = fadd fast float %FMad132, %224
  %325 = fmul fast float %.i0401, %213
  %FMad127 = call float @dx.op.tertiary.f32(i32 46, float %.i1402, float %217, float %325)  ; FMad(a,b,c)
  %FMad126 = call float @dx.op.tertiary.f32(i32 46, float %.i2403, float %221, float %FMad127)  ; FMad(a,b,c)
  %326 = fadd fast float %FMad126, %225
...
._crit_edge:                                      ; preds = %._crit_edge.loopexit, %"\01?internal.getImportanceRay@@YA?AV?$vector@M$02@@V1@0MV?$vector@M$01@@@Z.exit"
  ...
  %FMad94 = call float @dx.op.tertiary.f32(i32 46, float %vReflectionDirectionInView.0.lcssa.i1, float %385, float %392)  ; FMad(a,b,c)
  %FMad93 = call float @dx.op.tertiary.f32(i32 46, float %vReflectionDirectionInView.0.lcssa.i2, float %389, float %FMad94)  ; FMad(a,b,c)
  %393 = insertelement <3 x float> undef, float %FMad93, i64 0
  %394 = fmul fast float %382, %vReflectionDirectionInView.0.lcssa.i0
  %FMad92 = call float @dx.op.tertiary.f32(i32 46, float %vReflectionDirectionInView.0.lcssa.i1, float %386, float %394)  ; FMad(a,b,c)
  %FMad91 = call float @dx.op.tertiary.f32(i32 46, float %vReflectionDirectionInView.0.lcssa.i2, float %390, float %FMad92)  ; FMad(a,b,c)
  %395 = insertelement <3 x float> %393, float %FMad91, i64 1
  %396 = fmul fast float %383, %vReflectionDirectionInView.0.lcssa.i0
  %FMad90 = call float @dx.op.tertiary.f32(i32 46, float %vReflectionDirectionInView.0.lcssa.i1, float %387, float %396)  ; FMad(a,b,c)
  %FMad89 = call float @dx.op.tertiary.f32(i32 46, float %vReflectionDirectionInView.0.lcssa.i2, float %391, float %FMad90)  ; FMad(a,b,c)
  %397 = insertelement <3 x float> %395, float %FMad89, i64 2
  ...
  call void @dx.op.traceRay.struct.HitData(i32 157, %dx.types.Handle %401, i32 0, i32 1, i32 0, i32 2, i32 0, float %403, float %404, float %405, float %448, float %FMad93, float %FMad91, float %FMad89, float %400, %struct.HitData* nonnull %18)  ; TraceRay(AccelerationStructure,RayFlags,InstanceInclusionMask,RayContributionToHitGroupIndex,MultiplierForGeometryContributionToShaderIndex,MissShaderIndex,Origin_X,Origin_Y,Origin_Z,TMin,Direction_X,Direction_Y,Direction_Z,TMax,payload)
...
; <label>:408                                     ; preds = %._crit_edge
  ...
  %.i0381 = fmul fast float %FMad93, %410
  %.i1383 = fmul fast float %FMad91, %410
  %.i2385 = fmul fast float %FMad89, %410
  ...
  store <3 x float> %411, <3 x float>* %144, align 4, !tbaa !533
  ...
  %FMad112 = call float @dx.op.tertiary.f32(i32 46, float %414, float %421, float %428)  ; FMad(a,b,c)
  %FMad111 = call float @dx.op.tertiary.f32(i32 46, float %415, float %425, float %FMad112)  ; FMad(a,b,c)
  %429 = insertelement <3 x float> undef, float %FMad111, i64 0
  %430 = fmul fast float %418, %413
  %FMad110 = call float @dx.op.tertiary.f32(i32 46, float %414, float %422, float %430)  ; FMad(a,b,c)
  %FMad109 = call float @dx.op.tertiary.f32(i32 46, float %415, float %426, float %FMad110)  ; FMad(a,b,c)
  %431 = insertelement <3 x float> %429, float %FMad109, i64 1
  %432 = fmul fast float %419, %413
  %FMad108 = call float @dx.op.tertiary.f32(i32 46, float %414, float %423, float %432)  ; FMad(a,b,c)
  %FMad107 = call float @dx.op.tertiary.f32(i32 46, float %415, float %427, float %FMad108)  ; FMad(a,b,c)
  %433 = insertelement <3 x float> %431, float %FMad107, i64 2
  ...
  call void @dx.op.traceRay.struct.HitData(i32 157, %dx.types.Handle %434, i32 4, i32 1, i32 1, i32 2, i32 1, float %.i0387, float %.i1389, float %.i2391, float %448, float %FMad111, float %FMad109, float %FMad107, float 1.000000e+03, %struct.HitData* nonnull %17)  ; TraceRay(AccelerationStructure,RayFlags,InstanceInclusionMask,RayContributionToHitGroupIndex,MultiplierForGeometryContributionToShaderIndex,MissShaderIndex,Origin_X,Origin_Y,Origin_Z,TMin,Direction_X,Direction_Y,Direction_Z,TMax,payload)
  br label %435
