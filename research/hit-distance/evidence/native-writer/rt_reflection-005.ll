...
"\01?internal.getWorldSpaceNoiseOffset@@YA?AV?$vector@I$01@@V?$vector@M$01@@V?$matrix@M$03$03@@10MV?$vector@M$02@@22M_N@Z.exit33":
  ...
  %FMad90 = call float @dx.op.tertiary.f32(i32 46, float %.i1157433, float %26, float %40)  ; FMad(a,b,c)
  %FMad89 = call float @dx.op.tertiary.f32(i32 46, float %17, float %31, float %FMad90)  ; FMad(a,b,c)
  %41 = fadd fast float %FMad89, %36
  %42 = fmul fast float %22, %.i0156
  %FMad87 = call float @dx.op.tertiary.f32(i32 46, float %.i1157433, float %27, float %42)  ; FMad(a,b,c)
  %FMad86 = call float @dx.op.tertiary.f32(i32 46, float %17, float %32, float %FMad87)  ; FMad(a,b,c)
  %43 = fadd fast float %FMad86, %37
  %44 = fmul fast float %23, %.i0156
  %FMad84 = call float @dx.op.tertiary.f32(i32 46, float %.i1157433, float %28, float %44)  ; FMad(a,b,c)
  %FMad83 = call float @dx.op.tertiary.f32(i32 46, float %17, float %33, float %FMad84)  ; FMad(a,b,c)
  %45 = fadd fast float %FMad83, %38
  %46 = fmul fast float %24, %.i0156
  %FMad81 = call float @dx.op.tertiary.f32(i32 46, float %.i1157433, float %29, float %46)  ; FMad(a,b,c)
  %FMad80 = call float @dx.op.tertiary.f32(i32 46, float %17, float %34, float %FMad81)  ; FMad(a,b,c)
  %47 = fadd fast float %FMad80, %39
  ...
  %FMad102 = call float @dx.op.tertiary.f32(i32 46, float %.i1157433, float %60, float %74)  ; FMad(a,b,c)
  %FMad101 = call float @dx.op.tertiary.f32(i32 46, float %17, float %65, float %FMad102)  ; FMad(a,b,c)
  %75 = fadd fast float %FMad101, %70
  %76 = fmul fast float %56, %.i0156
  %FMad99 = call float @dx.op.tertiary.f32(i32 46, float %.i1157433, float %61, float %76)  ; FMad(a,b,c)
  %FMad98 = call float @dx.op.tertiary.f32(i32 46, float %17, float %66, float %FMad99)  ; FMad(a,b,c)
  %77 = fadd fast float %FMad98, %71
  %78 = fmul fast float %57, %.i0156
  %FMad96 = call float @dx.op.tertiary.f32(i32 46, float %.i1157433, float %62, float %78)  ; FMad(a,b,c)
  %FMad95 = call float @dx.op.tertiary.f32(i32 46, float %17, float %67, float %FMad96)  ; FMad(a,b,c)
  %79 = fadd fast float %FMad95, %72
  %80 = fmul fast float %58, %.i0156
  %FMad93 = call float @dx.op.tertiary.f32(i32 46, float %.i1157433, float %63, float %80)  ; FMad(a,b,c)
  %FMad92 = call float @dx.op.tertiary.f32(i32 46, float %17, float %68, float %FMad93)  ; FMad(a,b,c)
  %81 = fadd fast float %FMad92, %73
  ...
  %FMad78 = call float @dx.op.tertiary.f32(i32 46, float %.i1207, float %123, float %130)  ; FMad(a,b,c)
  %FMad77 = call float @dx.op.tertiary.f32(i32 46, float %.i2208, float %127, float %FMad78)  ; FMad(a,b,c)
  %131 = fmul fast float %120, %.i0206
  %FMad76 = call float @dx.op.tertiary.f32(i32 46, float %.i1207, float %124, float %131)  ; FMad(a,b,c)
  %FMad75 = call float @dx.op.tertiary.f32(i32 46, float %.i2208, float %128, float %FMad76)  ; FMad(a,b,c)
  %132 = fmul fast float %121, %.i0206
  %FMad74 = call float @dx.op.tertiary.f32(i32 46, float %.i1207, float %125, float %132)  ; FMad(a,b,c)
  %FMad = call float @dx.op.tertiary.f32(i32 46, float %.i2208, float %129, float %FMad74)  ; FMad(a,b,c)
  ...
  %.i0221 = fmul fast float %.i0209, %FMad77
  %.i1222 = fmul fast float %.i0209, %FMad75
  %.i2223 = fmul fast float %.i0209, %FMad
  ...
  %.i0231 = fmul fast float %FMad77, 4.000000e+00
  %.i1232 = fmul fast float %FMad75, 4.000000e+00
  %.i2233 = fmul fast float %FMad, 4.000000e+00
  ...
  %FMad110 = call float @dx.op.tertiary.f32(i32 46, float %17, float %142, float 0.000000e+00)  ; FMad(a,b,c)
  %176 = fadd fast float %FMad110, %145
  %FMad104 = call float @dx.op.tertiary.f32(i32 46, float %17, float %143, float 0.000000e+00)  ; FMad(a,b,c)
  %177 = fadd fast float %FMad104, %146
  %178 = fdiv fast float 1.000000e+00, %177
  %.i1238 = fmul fast float %178, %176
  %179 = fdiv fast float 2.000000e+00, %165
  %FMad123 = call float @dx.op.tertiary.f32(i32 46, float %179, float %139, float 0.000000e+00)  ; FMad(a,b,c)
  %FMad122 = call float @dx.op.tertiary.f32(i32 46, float %17, float %142, float %FMad123)  ; FMad(a,b,c)
  %180 = fadd fast float %FMad122, %145
  %FMad117 = call float @dx.op.tertiary.f32(i32 46, float %179, float %140, float 0.000000e+00)  ; FMad(a,b,c)
  %FMad116 = call float @dx.op.tertiary.f32(i32 46, float %17, float %143, float %FMad117)  ; FMad(a,b,c)
  %181 = fadd fast float %FMad116, %146
  ...
  %FMad138 = call float @dx.op.tertiary.f32(i32 46, float %.i1337, float %152, float %258)  ; FMad(a,b,c)
  %FMad137 = call float @dx.op.tertiary.f32(i32 46, float %.i2338, float %156, float %FMad138)  ; FMad(a,b,c)
  %259 = fadd fast float %FMad137, %160
  %260 = fmul fast float %.i0336, %149
  %FMad135 = call float @dx.op.tertiary.f32(i32 46, float %.i1337, float %153, float %260)  ; FMad(a,b,c)
  %FMad134 = call float @dx.op.tertiary.f32(i32 46, float %.i2338, float %157, float %FMad135)  ; FMad(a,b,c)
  %261 = fadd fast float %FMad134, %161
  %262 = fmul fast float %.i0336, %150
  %FMad129 = call float @dx.op.tertiary.f32(i32 46, float %.i1337, float %154, float %262)  ; FMad(a,b,c)
  %FMad128 = call float @dx.op.tertiary.f32(i32 46, float %.i2338, float %158, float %FMad129)  ; FMad(a,b,c)
  %263 = fadd fast float %FMad128, %162
...
._crit_edge:                                      ; preds = %.lr.ph, %.lr.ph30
  ...
  %FMad144 = call float @dx.op.tertiary.f32(i32 46, float %.i1292, float %277, float %284)  ; FMad(a,b,c)
  %FMad143 = call float @dx.op.tertiary.f32(i32 46, float %.i2293, float %281, float %FMad144)  ; FMad(a,b,c)
  %285 = fmul fast float %274, %.i0291
  %FMad142 = call float @dx.op.tertiary.f32(i32 46, float %.i1292, float %278, float %285)  ; FMad(a,b,c)
  %FMad141 = call float @dx.op.tertiary.f32(i32 46, float %.i2293, float %282, float %FMad142)  ; FMad(a,b,c)
  %286 = fmul fast float %275, %.i0291
  %FMad140 = call float @dx.op.tertiary.f32(i32 46, float %.i1292, float %279, float %286)  ; FMad(a,b,c)
  %FMad139 = call float @dx.op.tertiary.f32(i32 46, float %.i2293, float %283, float %FMad140)  ; FMad(a,b,c)
...
._crit_edge.31.loopexit:                          ; preds = %._crit_edge
  ...
  %FMad139.lcssa = phi float [ %FMad139, %._crit_edge ]
  %FMad141.lcssa = phi float [ %FMad141, %._crit_edge ]
  %FMad143.lcssa = phi float [ %FMad143, %._crit_edge ]
  %292 = getelementptr inbounds %struct.RayDesc, %struct.RayDesc* %ray, i32 0, i32 3
  %293 = insertelement <3 x float> undef, float %FMad143.lcssa, i64 0
  %294 = insertelement <3 x float> %293, float %FMad141.lcssa, i64 1
  %295 = insertelement <3 x float> %294, float %FMad139.lcssa, i64 2
