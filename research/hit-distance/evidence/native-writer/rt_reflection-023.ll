...
define void @"\01?reflectionRayGeneration@@YAXXZ"() #1 {
  ...
  %FMad136 = call float @dx.op.tertiary.f32(i32 46, float %.i1180508, float %34, float %48)  ; FMad(a,b,c)
  %FMad135 = call float @dx.op.tertiary.f32(i32 46, float %25, float %39, float %FMad136)  ; FMad(a,b,c)
  %49 = fadd fast float %FMad135, %44
  %50 = fmul fast float %30, %.i0179
  %FMad133 = call float @dx.op.tertiary.f32(i32 46, float %.i1180508, float %35, float %50)  ; FMad(a,b,c)
  %FMad132 = call float @dx.op.tertiary.f32(i32 46, float %25, float %40, float %FMad133)  ; FMad(a,b,c)
  %51 = fadd fast float %FMad132, %45
  %52 = fmul fast float %31, %.i0179
  %FMad130 = call float @dx.op.tertiary.f32(i32 46, float %.i1180508, float %36, float %52)  ; FMad(a,b,c)
  %FMad129 = call float @dx.op.tertiary.f32(i32 46, float %25, float %41, float %FMad130)  ; FMad(a,b,c)
  %53 = fadd fast float %FMad129, %46
  %54 = fmul fast float %32, %.i0179
  %FMad127 = call float @dx.op.tertiary.f32(i32 46, float %.i1180508, float %37, float %54)  ; FMad(a,b,c)
  %FMad126 = call float @dx.op.tertiary.f32(i32 46, float %25, float %42, float %FMad127)  ; FMad(a,b,c)
  %55 = fadd fast float %FMad126, %47
  ...
  %FMad118 = call float @dx.op.tertiary.f32(i32 46, float %.i1180508, float %68, float %82)  ; FMad(a,b,c)
  %FMad117 = call float @dx.op.tertiary.f32(i32 46, float %25, float %73, float %FMad118)  ; FMad(a,b,c)
  %83 = fadd fast float %FMad117, %78
  %84 = fmul fast float %64, %.i0179
  %FMad115 = call float @dx.op.tertiary.f32(i32 46, float %.i1180508, float %69, float %84)  ; FMad(a,b,c)
  %FMad114 = call float @dx.op.tertiary.f32(i32 46, float %25, float %74, float %FMad115)  ; FMad(a,b,c)
  %85 = fadd fast float %FMad114, %79
  %86 = fmul fast float %65, %.i0179
  %FMad112 = call float @dx.op.tertiary.f32(i32 46, float %.i1180508, float %70, float %86)  ; FMad(a,b,c)
  %FMad111 = call float @dx.op.tertiary.f32(i32 46, float %25, float %75, float %FMad112)  ; FMad(a,b,c)
  %87 = fadd fast float %FMad111, %80
  %88 = fmul fast float %66, %.i0179
  %FMad109 = call float @dx.op.tertiary.f32(i32 46, float %.i1180508, float %71, float %88)  ; FMad(a,b,c)
  %FMad108 = call float @dx.op.tertiary.f32(i32 46, float %25, float %76, float %FMad109)  ; FMad(a,b,c)
  %89 = fadd fast float %FMad108, %81
...
"\01?internal.getReflectionRayCount@@YAHV?$vector@M$02@@M@Z.exit": ; preds = %180, %"\01?internal.getMaterialSpecular@@YA?AV?$vector@M$02@@IM@Z.exit"
  ...
  %FMad156 = call float @dx.op.tertiary.f32(i32 46, float %25, float %197, float 0.000000e+00)  ; FMad(a,b,c)
  %231 = fadd fast float %FMad156, %200
  %FMad150 = call float @dx.op.tertiary.f32(i32 46, float %25, float %198, float 0.000000e+00)  ; FMad(a,b,c)
  %232 = fadd fast float %FMad150, %201
...
._crit_edge:                                      ; preds = %.lr.ph, %.lr.ph31
  ...
  %FMad124 = call float @dx.op.tertiary.f32(i32 46, float %.i1345, float %332, float %339)  ; FMad(a,b,c)
  %FMad123 = call float @dx.op.tertiary.f32(i32 46, float %.i2346, float %336, float %FMad124)  ; FMad(a,b,c)
  %340 = insertelement <3 x float> undef, float %FMad123, i64 0
  %341 = fmul fast float %329, %.i0344
  %FMad122 = call float @dx.op.tertiary.f32(i32 46, float %.i1345, float %333, float %341)  ; FMad(a,b,c)
  %FMad121 = call float @dx.op.tertiary.f32(i32 46, float %.i2346, float %337, float %FMad122)  ; FMad(a,b,c)
  %342 = insertelement <3 x float> %340, float %FMad121, i64 1
  %343 = fmul fast float %330, %.i0344
  %FMad120 = call float @dx.op.tertiary.f32(i32 46, float %.i1345, float %334, float %343)  ; FMad(a,b,c)
  %FMad119 = call float @dx.op.tertiary.f32(i32 46, float %.i2346, float %338, float %FMad120)  ; FMad(a,b,c)
  %344 = insertelement <3 x float> %342, float %FMad119, i64 2
  ...
  call void @dx.op.traceRay.struct.HitData(i32 157, %dx.types.Handle %348, i32 0, i32 1, i32 0, i32 2, i32 0, float %350, float %351, float %352, float %389, float %FMad123, float %FMad121, float %FMad119, float %347, %struct.HitData* nonnull %18)  ; TraceRay(AccelerationStructure,RayFlags,InstanceInclusionMask,RayContributionToHitGroupIndex,MultiplierForGeometryContributionToShaderIndex,MissShaderIndex,Origin_X,Origin_Y,Origin_Z,TMin,Direction_X,Direction_Y,Direction_Z,TMax,payload)
...
; <label>:355                                     ; preds = %._crit_edge
  ...
  %.i0381 = fmul fast float %FMad123, %357
  %.i1383 = fmul fast float %FMad121, %357
  %.i2385 = fmul fast float %FMad119, %357
  ...
  %FMad94 = call float @dx.op.tertiary.f32(i32 46, float %361, float %368, float %375)  ; FMad(a,b,c)
  %FMad93 = call float @dx.op.tertiary.f32(i32 46, float %362, float %372, float %FMad94)  ; FMad(a,b,c)
  %376 = insertelement <3 x float> undef, float %FMad93, i64 0
  %377 = fmul fast float %365, %360
  %FMad92 = call float @dx.op.tertiary.f32(i32 46, float %361, float %369, float %377)  ; FMad(a,b,c)
  %FMad91 = call float @dx.op.tertiary.f32(i32 46, float %362, float %373, float %FMad92)  ; FMad(a,b,c)
  %378 = insertelement <3 x float> %376, float %FMad91, i64 1
  %379 = fmul fast float %366, %360
  %FMad90 = call float @dx.op.tertiary.f32(i32 46, float %361, float %370, float %379)  ; FMad(a,b,c)
  %FMad89 = call float @dx.op.tertiary.f32(i32 46, float %362, float %374, float %FMad90)  ; FMad(a,b,c)
  %380 = insertelement <3 x float> %378, float %FMad89, i64 2
  ...
  call void @dx.op.traceRay.struct.HitData(i32 157, %dx.types.Handle %381, i32 4, i32 1, i32 1, i32 2, i32 1, float %.i0387, float %.i1389, float %.i2391, float %389, float %FMad93, float %FMad91, float %FMad89, float 1.000000e+03, %struct.HitData* nonnull %17)  ; TraceRay(AccelerationStructure,RayFlags,InstanceInclusionMask,RayContributionToHitGroupIndex,MultiplierForGeometryContributionToShaderIndex,MissShaderIndex,Origin_X,Origin_Y,Origin_Z,TMin,Direction_X,Direction_Y,Direction_Z,TMax,payload)
  br label %382
