...
define void @"\01?reflectionRayGeneration@@YAXXZ"() #0 {
  ...
  %FMad130 = call float @dx.op.tertiary.f32(i32 46, float %.i1180508, float %34, float %48)  ; FMad(a,b,c)
  %FMad129 = call float @dx.op.tertiary.f32(i32 46, float %25, float %39, float %FMad130)  ; FMad(a,b,c)
  %49 = fadd fast float %FMad129, %44
  %50 = fmul fast float %30, %.i0179
  %FMad127 = call float @dx.op.tertiary.f32(i32 46, float %.i1180508, float %35, float %50)  ; FMad(a,b,c)
  %FMad126 = call float @dx.op.tertiary.f32(i32 46, float %25, float %40, float %FMad127)  ; FMad(a,b,c)
  %51 = fadd fast float %FMad126, %45
  %52 = fmul fast float %31, %.i0179
  %FMad124 = call float @dx.op.tertiary.f32(i32 46, float %.i1180508, float %36, float %52)  ; FMad(a,b,c)
  %FMad123 = call float @dx.op.tertiary.f32(i32 46, float %25, float %41, float %FMad124)  ; FMad(a,b,c)
  %53 = fadd fast float %FMad123, %46
  %54 = fmul fast float %32, %.i0179
  %FMad121 = call float @dx.op.tertiary.f32(i32 46, float %.i1180508, float %37, float %54)  ; FMad(a,b,c)
  %FMad120 = call float @dx.op.tertiary.f32(i32 46, float %25, float %42, float %FMad121)  ; FMad(a,b,c)
  %55 = fadd fast float %FMad120, %47
  ...
  %FMad88 = call float @dx.op.tertiary.f32(i32 46, float %.i1230, float %131, float %138)  ; FMad(a,b,c)
  %FMad87 = call float @dx.op.tertiary.f32(i32 46, float %.i2231, float %135, float %FMad88)  ; FMad(a,b,c)
  %139 = fmul fast float %128, %.i0229
  %FMad86 = call float @dx.op.tertiary.f32(i32 46, float %.i1230, float %132, float %139)  ; FMad(a,b,c)
  %FMad85 = call float @dx.op.tertiary.f32(i32 46, float %.i2231, float %136, float %FMad86)  ; FMad(a,b,c)
  %140 = fmul fast float %129, %.i0229
  %FMad84 = call float @dx.op.tertiary.f32(i32 46, float %.i1230, float %133, float %140)  ; FMad(a,b,c)
  %FMad = call float @dx.op.tertiary.f32(i32 46, float %.i2231, float %137, float %FMad84)  ; FMad(a,b,c)
  ...
  %.i0244 = fmul fast float %.i0232, %FMad87
  %.i1245 = fmul fast float %.i0232, %FMad85
  %.i2246 = fmul fast float %.i0232, %FMad
  ...
  store <3 x float> %141, <3 x float>* %142, align 4, !tbaa !535
  %143 = getelementptr inbounds %struct.RayDesc, %struct.RayDesc* %ray, i32 0, i32 1
  store float 0.000000e+00, float* %143, align 4, !tbaa !550
...
"\01?internal.getMaterialSpecular@@YA?AV?$vector@M$02@@IM@Z.exit": ; preds = %166, %0
  ...
  %171 = call float @dx.op.dot3.f32(i32 55, float %FMad87, float %FMad85, float %FMad, float %.i0268, float %.i1269, float %.i2270)  ; Dot3(ax,ay,az,bx,by,bz)
...
"\01?internal.getReflectionRayCount@@YAHV?$vector@M$02@@M@Z.exit": ; preds = %180, %"\01?internal.getMaterialSpecular@@YA?AV?$vector@M$02@@IM@Z.exit"
  ...
  %.i0284 = fmul fast float %FMad87, 4.000000e+00
  %.i1285 = fmul fast float %FMad85, 4.000000e+00
  %.i2286 = fmul fast float %FMad, 4.000000e+00
  ...
  %FMad108 = call float @dx.op.tertiary.f32(i32 46, float %25, float %197, float 0.000000e+00)  ; FMad(a,b,c)
  %231 = fadd fast float %FMad108, %200
  %FMad102 = call float @dx.op.tertiary.f32(i32 46, float %25, float %198, float 0.000000e+00)  ; FMad(a,b,c)
  %232 = fadd fast float %FMad102, %201
  ...
  store i32 0, i32* %243, align 4, !tbaa !543
  ...
  %271 = load float, float* %221, align 4, !tbaa !550
  ...
  %277 = load float, float* %222, align 4, !tbaa !550
  ...
  %283 = load float, float* %223, align 4, !tbaa !550
  ...
  store float 0.000000e+00, float* %292, align 4, !tbaa !550
  ...
  %FMad100 = call float @dx.op.tertiary.f32(i32 46, float %.i1402, float %207, float %313)  ; FMad(a,b,c)
  %FMad99 = call float @dx.op.tertiary.f32(i32 46, float %.i2403, float %211, float %FMad100)  ; FMad(a,b,c)
  %314 = fadd fast float %FMad99, %215
  %315 = fmul fast float %.i0401, %204
  %FMad97 = call float @dx.op.tertiary.f32(i32 46, float %.i1402, float %208, float %315)  ; FMad(a,b,c)
  %FMad96 = call float @dx.op.tertiary.f32(i32 46, float %.i2403, float %212, float %FMad97)  ; FMad(a,b,c)
  %316 = fadd fast float %FMad96, %216
  %317 = fmul fast float %.i0401, %205
  %FMad91 = call float @dx.op.tertiary.f32(i32 46, float %.i1402, float %209, float %317)  ; FMad(a,b,c)
  %FMad90 = call float @dx.op.tertiary.f32(i32 46, float %.i2403, float %213, float %FMad91)  ; FMad(a,b,c)
  %318 = fadd fast float %FMad90, %217
...
._crit_edge:                                      ; preds = %.lr.ph, %.lr.ph31
  ...
  %FMad148 = call float @dx.op.tertiary.f32(i32 46, float %.i1345, float %332, float %339)  ; FMad(a,b,c)
  %FMad147 = call float @dx.op.tertiary.f32(i32 46, float %.i2346, float %336, float %FMad148)  ; FMad(a,b,c)
  %340 = insertelement <3 x float> undef, float %FMad147, i64 0
  %341 = fmul fast float %329, %.i0344
  %FMad146 = call float @dx.op.tertiary.f32(i32 46, float %.i1345, float %333, float %341)  ; FMad(a,b,c)
  %FMad145 = call float @dx.op.tertiary.f32(i32 46, float %.i2346, float %337, float %FMad146)  ; FMad(a,b,c)
  %342 = insertelement <3 x float> %340, float %FMad145, i64 1
  %343 = fmul fast float %330, %.i0344
  %FMad144 = call float @dx.op.tertiary.f32(i32 46, float %.i1345, float %334, float %343)  ; FMad(a,b,c)
  %FMad143 = call float @dx.op.tertiary.f32(i32 46, float %.i2346, float %338, float %FMad144)  ; FMad(a,b,c)
  %344 = insertelement <3 x float> %342, float %FMad143, i64 2
  ...
  call void @dx.op.traceRay.struct.HitData(i32 157, %dx.types.Handle %348, i32 0, i32 1, i32 0, i32 2, i32 0, float %350, float %351, float %352, float %389, float %FMad147, float %FMad145, float %FMad143, float %347, %struct.HitData* nonnull %18)  ; TraceRay(AccelerationStructure,RayFlags,InstanceInclusionMask,RayContributionToHitGroupIndex,MultiplierForGeometryContributionToShaderIndex,MissShaderIndex,Origin_X,Origin_Y,Origin_Z,TMin,Direction_X,Direction_Y,Direction_Z,TMax,payload)
...
; <label>:355                                     ; preds = %._crit_edge
  ...
  %.i0381 = fmul fast float %FMad147, %357
  %.i1383 = fmul fast float %FMad145, %357
  %.i2385 = fmul fast float %FMad143, %357
  ...
  store <3 x float> %358, <3 x float>* %142, align 4, !tbaa !535
  ...
  %FMad118 = call float @dx.op.tertiary.f32(i32 46, float %361, float %368, float %375)  ; FMad(a,b,c)
  %FMad117 = call float @dx.op.tertiary.f32(i32 46, float %362, float %372, float %FMad118)  ; FMad(a,b,c)
  %376 = insertelement <3 x float> undef, float %FMad117, i64 0
  %377 = fmul fast float %365, %360
  %FMad116 = call float @dx.op.tertiary.f32(i32 46, float %361, float %369, float %377)  ; FMad(a,b,c)
  %FMad115 = call float @dx.op.tertiary.f32(i32 46, float %362, float %373, float %FMad116)  ; FMad(a,b,c)
  %378 = insertelement <3 x float> %376, float %FMad115, i64 1
  %379 = fmul fast float %366, %360
  %FMad114 = call float @dx.op.tertiary.f32(i32 46, float %361, float %370, float %379)  ; FMad(a,b,c)
  %FMad113 = call float @dx.op.tertiary.f32(i32 46, float %362, float %374, float %FMad114)  ; FMad(a,b,c)
  %380 = insertelement <3 x float> %378, float %FMad113, i64 2
  ...
  call void @dx.op.traceRay.struct.HitData(i32 157, %dx.types.Handle %381, i32 4, i32 1, i32 1, i32 2, i32 1, float %.i0387, float %.i1389, float %.i2391, float %389, float %FMad117, float %FMad115, float %FMad113, float 1.000000e+03, %struct.HitData* nonnull %17)  ; TraceRay(AccelerationStructure,RayFlags,InstanceInclusionMask,RayContributionToHitGroupIndex,MultiplierForGeometryContributionToShaderIndex,MissShaderIndex,Origin_X,Origin_Y,Origin_Z,TMin,Direction_X,Direction_Y,Direction_Z,TMax,payload)
  br label %382
