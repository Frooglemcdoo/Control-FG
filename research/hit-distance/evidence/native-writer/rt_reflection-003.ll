...
"\01?internal.getWorldSpaceNoiseOffset@@YA?AV?$vector@I$01@@V?$vector@M$01@@V?$matrix@M$03$03@@10MV?$vector@M$02@@22M_N@Z.exit33":
  ...
  %FMad78 = call float @dx.op.tertiary.f32(i32 46, float %.i1213, float %126, float %133)  ; FMad(a,b,c)
  %FMad77 = call float @dx.op.tertiary.f32(i32 46, float %.i2214, float %130, float %FMad78)  ; FMad(a,b,c)
  %134 = fmul fast float %123, %.i0212
  %FMad76 = call float @dx.op.tertiary.f32(i32 46, float %.i1213, float %127, float %134)  ; FMad(a,b,c)
  %FMad75 = call float @dx.op.tertiary.f32(i32 46, float %.i2214, float %131, float %FMad76)  ; FMad(a,b,c)
  %135 = fmul fast float %124, %.i0212
  %FMad74 = call float @dx.op.tertiary.f32(i32 46, float %.i1213, float %128, float %135)  ; FMad(a,b,c)
  %FMad = call float @dx.op.tertiary.f32(i32 46, float %.i2214, float %132, float %FMad74)  ; FMad(a,b,c)
  ...
  %.i0227 = fmul fast float %.i0215, %FMad77
  %.i1228 = fmul fast float %.i0215, %FMad75
  %.i2229 = fmul fast float %.i0215, %FMad
  ...
  %.i0237 = fmul fast float %FMad77, 4.000000e+00
  %.i1238 = fmul fast float %FMad75, 4.000000e+00
  %.i2239 = fmul fast float %FMad, 4.000000e+00
  ...
  %FMad98 = call float @dx.op.tertiary.f32(i32 46, float %19, float %146, float 0.000000e+00)  ; FMad(a,b,c)
  %180 = fadd fast float %FMad98, %149
  %FMad92 = call float @dx.op.tertiary.f32(i32 46, float %19, float %147, float 0.000000e+00)  ; FMad(a,b,c)
  %181 = fadd fast float %FMad92, %150
  %182 = fdiv fast float 1.000000e+00, %181
  %.i1244 = fmul fast float %182, %180
  %183 = fdiv fast float 2.000000e+00, %169
  %FMad111 = call float @dx.op.tertiary.f32(i32 46, float %183, float %143, float 0.000000e+00)  ; FMad(a,b,c)
  %FMad110 = call float @dx.op.tertiary.f32(i32 46, float %19, float %146, float %FMad111)  ; FMad(a,b,c)
  %184 = fadd fast float %FMad110, %149
  %FMad105 = call float @dx.op.tertiary.f32(i32 46, float %183, float %144, float 0.000000e+00)  ; FMad(a,b,c)
  %FMad104 = call float @dx.op.tertiary.f32(i32 46, float %19, float %147, float %FMad105)  ; FMad(a,b,c)
  %185 = fadd fast float %FMad104, %150
  ...
  %FMad90 = call float @dx.op.tertiary.f32(i32 46, float %.i1355, float %156, float %262)  ; FMad(a,b,c)
  %FMad89 = call float @dx.op.tertiary.f32(i32 46, float %.i2356, float %160, float %FMad90)  ; FMad(a,b,c)
  %263 = fadd fast float %FMad89, %164
  %264 = fmul fast float %.i0354, %153
  %FMad87 = call float @dx.op.tertiary.f32(i32 46, float %.i1355, float %157, float %264)  ; FMad(a,b,c)
  %FMad86 = call float @dx.op.tertiary.f32(i32 46, float %.i2356, float %161, float %FMad87)  ; FMad(a,b,c)
  %265 = fadd fast float %FMad86, %165
  %266 = fmul fast float %.i0354, %154
  %FMad81 = call float @dx.op.tertiary.f32(i32 46, float %.i1355, float %158, float %266)  ; FMad(a,b,c)
  %FMad80 = call float @dx.op.tertiary.f32(i32 46, float %.i2356, float %162, float %FMad81)  ; FMad(a,b,c)
  %267 = fadd fast float %FMad80, %166
...
; <label>:349                                     ; preds = %._crit_edge
  ...
  %FMad120 = call float @dx.op.tertiary.f32(i32 46, float %355, float %362, float %369)  ; FMad(a,b,c)
  %FMad119 = call float @dx.op.tertiary.f32(i32 46, float %356, float %366, float %FMad120)  ; FMad(a,b,c)
  %370 = insertelement <3 x float> undef, float %FMad119, i64 0
  %371 = fmul fast float %359, %354
  %FMad118 = call float @dx.op.tertiary.f32(i32 46, float %355, float %363, float %371)  ; FMad(a,b,c)
  %FMad117 = call float @dx.op.tertiary.f32(i32 46, float %356, float %367, float %FMad118)  ; FMad(a,b,c)
  %372 = insertelement <3 x float> %370, float %FMad117, i64 1
  %373 = fmul fast float %360, %354
  %FMad116 = call float @dx.op.tertiary.f32(i32 46, float %355, float %364, float %373)  ; FMad(a,b,c)
  %FMad115 = call float @dx.op.tertiary.f32(i32 46, float %356, float %368, float %FMad116)  ; FMad(a,b,c)
  %374 = insertelement <3 x float> %372, float %FMad115, i64 2
  ...
  call void @dx.op.traceRay.struct.HitData(i32 157, %dx.types.Handle %375, i32 4, i32 1, i32 1, i32 2, i32 1, float %.i0340, float %.i1342, float %.i2344, float %389, float %FMad119, float %FMad117, float %FMad115, float 1.000000e+03, %struct.HitData* nonnull %11)  ; TraceRay(AccelerationStructure,RayFlags,InstanceInclusionMask,RayContributionToHitGroupIndex,MultiplierForGeometryContributionToShaderIndex,MissShaderIndex,Origin_X,Origin_Y,Origin_Z,TMin,Direction_X,Direction_Y,Direction_Z,TMax,payload)
  br label %376
