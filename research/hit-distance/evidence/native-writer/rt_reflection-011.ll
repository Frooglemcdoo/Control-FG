...
"\01?internal.getWorldSpaceNoiseOffset@@YA?AV?$vector@I$01@@V?$vector@M$01@@V?$matrix@M$03$03@@10MV?$vector@M$02@@22M_N@Z.exit33":
  ...
  %FMad126 = call float @dx.op.tertiary.f32(i32 46, float %.i1163453, float %28, float %42)  ; FMad(a,b,c)
  %FMad125 = call float @dx.op.tertiary.f32(i32 46, float %19, float %33, float %FMad126)  ; FMad(a,b,c)
  %43 = fadd fast float %FMad125, %38
  %44 = fmul fast float %24, %.i0162
  %FMad123 = call float @dx.op.tertiary.f32(i32 46, float %.i1163453, float %29, float %44)  ; FMad(a,b,c)
  %FMad122 = call float @dx.op.tertiary.f32(i32 46, float %19, float %34, float %FMad123)  ; FMad(a,b,c)
  %45 = fadd fast float %FMad122, %39
  %46 = fmul fast float %25, %.i0162
  %FMad120 = call float @dx.op.tertiary.f32(i32 46, float %.i1163453, float %30, float %46)  ; FMad(a,b,c)
  %FMad119 = call float @dx.op.tertiary.f32(i32 46, float %19, float %35, float %FMad120)  ; FMad(a,b,c)
  %47 = fadd fast float %FMad119, %40
  %48 = fmul fast float %26, %.i0162
  %FMad117 = call float @dx.op.tertiary.f32(i32 46, float %.i1163453, float %31, float %48)  ; FMad(a,b,c)
  %FMad116 = call float @dx.op.tertiary.f32(i32 46, float %19, float %36, float %FMad117)  ; FMad(a,b,c)
  %49 = fadd fast float %FMad116, %41
  ...
  %FMad90 = call float @dx.op.tertiary.f32(i32 46, float %.i1163453, float %62, float %76)  ; FMad(a,b,c)
  %FMad89 = call float @dx.op.tertiary.f32(i32 46, float %19, float %67, float %FMad90)  ; FMad(a,b,c)
  %77 = fadd fast float %FMad89, %72
  %78 = fmul fast float %58, %.i0162
  %FMad87 = call float @dx.op.tertiary.f32(i32 46, float %.i1163453, float %63, float %78)  ; FMad(a,b,c)
  %FMad86 = call float @dx.op.tertiary.f32(i32 46, float %19, float %68, float %FMad87)  ; FMad(a,b,c)
  %79 = fadd fast float %FMad86, %73
  %80 = fmul fast float %59, %.i0162
  %FMad84 = call float @dx.op.tertiary.f32(i32 46, float %.i1163453, float %64, float %80)  ; FMad(a,b,c)
  %FMad83 = call float @dx.op.tertiary.f32(i32 46, float %19, float %69, float %FMad84)  ; FMad(a,b,c)
  %81 = fadd fast float %FMad83, %74
  %82 = fmul fast float %60, %.i0162
  %FMad81 = call float @dx.op.tertiary.f32(i32 46, float %.i1163453, float %65, float %82)  ; FMad(a,b,c)
  %FMad80 = call float @dx.op.tertiary.f32(i32 46, float %19, float %70, float %FMad81)  ; FMad(a,b,c)
  %83 = fadd fast float %FMad80, %75
  ...
  %97 = extractvalue %dx.types.ResRet.f32 %TextureLoad152, 2
  %98 = extractvalue %dx.types.ResRet.f32 %TextureLoad152, 3
  %99 = fmul fast float %98, 2.550000e+02
  ...
  %.i2187 = fadd fast float %103, 5.000000e-01
  ...
  %104 = sitofp i32 %.i0197 to float
  %105 = sitofp i32 %.i1198 to float
  %106 = fmul fast float %104, 0x3F54CF66A0000000
  %.i0205 = fadd fast float %106, 0xBFF4CCCCC0000000
  %107 = fmul fast float %105, 0x3F44CE19C0000000
  %.i1206 = fadd fast float %107, 0xBFF4CCCCC0000000
  %108 = fmul fast float %.i0205, %.i0205
  %109 = fmul fast float %.i1206, %.i1206
  %110 = fadd fast float %108, 1.000000e+00
  %111 = fadd fast float %110, %109
  %112 = fmul fast float %104, 0x3F64CF66A0000000
  %.i0207 = fadd fast float %112, 0xC004CCCCC0000000
  %113 = fmul fast float %105, 0x3F54CE19C0000000
  %.i1208 = fadd fast float %113, 0xC004CCCCC0000000
  %114 = fadd fast float %109, -1.000000e+00
  %115 = fadd fast float %114, %108
  %.i0209 = fdiv fast float %.i0207, %111
  %.i1210 = fdiv fast float %.i1208, %111
  %.i2211 = fdiv fast float %115, %111
  %116 = fmul fast float %.i0209, %.i0209
  %117 = fmul fast float %.i1210, %.i1210
  %118 = fadd fast float %117, %116
  %119 = fmul fast float %.i2211, %.i2211
  %120 = fadd fast float %118, %119
  %Sqrt68 = call float @dx.op.unary.f32(i32 24, float %120)  ; Sqrt(value)
  %.i0212 = fdiv fast float %.i0209, %Sqrt68
  %.i1213 = fdiv fast float %.i1210, %Sqrt68
  %.i2214 = fdiv fast float %.i2211, %Sqrt68
  %121 = call %dx.types.CBufRet.f32 @dx.op.cbufferLoadLegacy.f32(i32 59, %dx.types.Handle %sys_constants, i32 6)  ; CBufferLoadLegacy(handle,regIndex)
  ...
  %125 = call %dx.types.CBufRet.f32 @dx.op.cbufferLoadLegacy.f32(i32 59, %dx.types.Handle %sys_constants, i32 7)  ; CBufferLoadLegacy(handle,regIndex)
  ...
  %129 = call %dx.types.CBufRet.f32 @dx.op.cbufferLoadLegacy.f32(i32 59, %dx.types.Handle %sys_constants, i32 8)  ; CBufferLoadLegacy(handle,regIndex)
  ...
  %FMad150 = call float @dx.op.tertiary.f32(i32 46, float %.i1213, float %126, float %133)  ; FMad(a,b,c)
  %FMad149 = call float @dx.op.tertiary.f32(i32 46, float %.i2214, float %130, float %FMad150)  ; FMad(a,b,c)
  %134 = fmul fast float %123, %.i0212
  %FMad148 = call float @dx.op.tertiary.f32(i32 46, float %.i1213, float %127, float %134)  ; FMad(a,b,c)
  %FMad147 = call float @dx.op.tertiary.f32(i32 46, float %.i2214, float %131, float %FMad148)  ; FMad(a,b,c)
  %135 = fmul fast float %124, %.i0212
  %FMad146 = call float @dx.op.tertiary.f32(i32 46, float %.i1213, float %128, float %135)  ; FMad(a,b,c)
  %FMad145 = call float @dx.op.tertiary.f32(i32 46, float %.i2214, float %132, float %FMad146)  ; FMad(a,b,c)
  %136 = fsub fast float 1.000000e+00, %97
  ...
  %.i0227 = fmul fast float %.i0215, %FMad149
  %.i1228 = fmul fast float %.i0215, %FMad147
  %.i2229 = fmul fast float %.i0215, %FMad145
  ...
  %137 = insertelement <3 x float> %.upto1396, float %.i2232, i32 2
  %138 = getelementptr inbounds %struct.RayDesc, %struct.RayDesc* %ray, i32 0, i32 0
  store <3 x float> %137, <3 x float>* %138, align 4, !tbaa !517
  %139 = getelementptr inbounds %struct.RayDesc, %struct.RayDesc* %ray, i32 0, i32 1
  store float 0.000000e+00, float* %139, align 4, !tbaa !520
  %140 = call %dx.types.CBufRet.i32 @dx.op.cbufferLoadLegacy.i32(i32 59, %dx.types.Handle %rtreflection, i32 0)  ; CBufferLoadLegacy(handle,regIndex)
  %141 = extractvalue %dx.types.CBufRet.i32 %140, 2
  %142 = call %dx.types.CBufRet.f32 @dx.op.cbufferLoadLegacy.f32(i32 59, %dx.types.Handle %sys_constants, i32 15)  ; CBufferLoadLegacy(handle,regIndex)
  %143 = extractvalue %dx.types.CBufRet.f32 %142, 1
  %144 = extractvalue %dx.types.CBufRet.f32 %142, 3
  %145 = call %dx.types.CBufRet.f32 @dx.op.cbufferLoadLegacy.f32(i32 59, %dx.types.Handle %sys_constants, i32 16)  ; CBufferLoadLegacy(handle,regIndex)
  %146 = extractvalue %dx.types.CBufRet.f32 %145, 1
  %147 = extractvalue %dx.types.CBufRet.f32 %145, 3
  %148 = call %dx.types.CBufRet.f32 @dx.op.cbufferLoadLegacy.f32(i32 59, %dx.types.Handle %sys_constants, i32 17)  ; CBufferLoadLegacy(handle,regIndex)
  %149 = extractvalue %dx.types.CBufRet.f32 %148, 1
  %150 = extractvalue %dx.types.CBufRet.f32 %148, 3
  %151 = call %dx.types.CBufRet.f32 @dx.op.cbufferLoadLegacy.f32(i32 59, %dx.types.Handle %sys_constants, i32 18)  ; CBufferLoadLegacy(handle,regIndex)
  ...
  %155 = call %dx.types.CBufRet.f32 @dx.op.cbufferLoadLegacy.f32(i32 59, %dx.types.Handle %sys_constants, i32 19)  ; CBufferLoadLegacy(handle,regIndex)
  ...
  %159 = call %dx.types.CBufRet.f32 @dx.op.cbufferLoadLegacy.f32(i32 59, %dx.types.Handle %sys_constants, i32 20)  ; CBufferLoadLegacy(handle,regIndex)
  ...
  %163 = call %dx.types.CBufRet.f32 @dx.op.cbufferLoadLegacy.f32(i32 59, %dx.types.Handle %sys_constants, i32 21)  ; CBufferLoadLegacy(handle,regIndex)
  ...
  %167 = call %dx.types.CBufRet.f32 @dx.op.cbufferLoadLegacy.f32(i32 59, %dx.types.Handle %sys_constants, i32 0)  ; CBufferLoadLegacy(handle,regIndex)
  %168 = extractvalue %dx.types.CBufRet.f32 %167, 0
  %169 = extractvalue %dx.types.CBufRet.f32 %167, 1
  %170 = getelementptr inbounds [3 x float], [3 x float]* %0, i32 0, i32 0
  store float %.i0173, float* %170, align 4
  %171 = getelementptr inbounds [3 x float], [3 x float]* %0, i32 0, i32 1
  store float %.i1174, float* %171, align 4
  %172 = getelementptr inbounds [3 x float], [3 x float]* %0, i32 0, i32 2
  store float %.i2175, float* %172, align 4
  %.i0237 = fmul fast float %FMad149, 4.000000e+00
  %.i1238 = fmul fast float %FMad147, 4.000000e+00
  %.i2239 = fmul fast float %FMad145, 4.000000e+00
  ...
  %173 = fmul fast float %Round_ne, %Round_ne
  %174 = fmul fast float %Round_ne49, %Round_ne49
  %175 = fadd fast float %174, %173
  %176 = fmul fast float %Round_ne50, %Round_ne50
  %177 = fadd fast float %175, %176
  %Sqrt48 = call float @dx.op.unary.f32(i32 24, float %177)  ; Sqrt(value)
  ...
  %178 = fcmp fast oeq float %FMax72, %FAbs58
  %iMajorAxis.i.0 = zext i1 %178 to i32
  %179 = fcmp fast oeq float %FMax72, %FAbs59
  %iMajorAxis.i.1 = select i1 %179, i32 2, i32 %iMajorAxis.i.0
  %FMad110 = call float @dx.op.tertiary.f32(i32 46, float %19, float %146, float 0.000000e+00)  ; FMad(a,b,c)
  %180 = fadd fast float %FMad110, %149
  %FMad104 = call float @dx.op.tertiary.f32(i32 46, float %19, float %147, float 0.000000e+00)  ; FMad(a,b,c)
  %181 = fadd fast float %FMad104, %150
  %182 = fdiv fast float 1.000000e+00, %181
  %.i1244 = fmul fast float %182, %180
  %183 = fdiv fast float 2.000000e+00, %169
  %FMad99 = call float @dx.op.tertiary.f32(i32 46, float %183, float %143, float 0.000000e+00)  ; FMad(a,b,c)
  %FMad98 = call float @dx.op.tertiary.f32(i32 46, float %19, float %146, float %FMad99)  ; FMad(a,b,c)
  %184 = fadd fast float %FMad98, %149
  %FMad93 = call float @dx.op.tertiary.f32(i32 46, float %183, float %144, float 0.000000e+00)  ; FMad(a,b,c)
  %FMad92 = call float @dx.op.tertiary.f32(i32 46, float %19, float %147, float %FMad93)  ; FMad(a,b,c)
  %185 = fadd fast float %FMad92, %150
  %186 = fdiv fast float 1.000000e+00, %185
  %.i1247 = fmul fast float %186, %184
  %187 = fsub fast float %.i1247, %.i1244
  %FAbs = call float @dx.op.unary.f32(i32 6, float %187)  ; FAbs(value)
  %188 = fmul fast float %FAbs, 6.400000e+01
  %Log = call float @dx.op.unary.f32(i32 23, float %188)  ; Log(value)
  ...
  %189 = getelementptr inbounds [3 x i32], [3 x i32]* %1, i32 0, i32 0
  store i32 %.i0252, i32* %189, align 4
  %190 = getelementptr inbounds [3 x i32], [3 x i32]* %1, i32 0, i32 1
  store i32 %.i1253, i32* %190, align 4
  %191 = getelementptr inbounds [3 x i32], [3 x i32]* %1, i32 0, i32 2
  store i32 %.i2254, i32* %191, align 4
  %192 = getelementptr [3 x i32], [3 x i32]* %1, i32 0, i32 %iMajorAxis.i.1
  store i32 0, i32* %192, align 4, !tbaa !522
  ...
  %206 = lshr i32 %205, 4
  %207 = xor i32 %206, %205
  %208 = mul i32 %207, 668265261
  %209 = lshr i32 %208, 15
  %210 = xor i32 %209, %208
  %211 = uitofp i32 %210 to float
  %212 = fmul fast float %211, 0x3DF0000000000000
  %213 = fdiv fast float %188, %Exp
  %214 = fmul fast float %213, 4.000000e+00
  %215 = fadd fast float %214, -2.000000e+00
  %216 = fsub fast float %215, %212
  %Saturate40 = call float @dx.op.unary.f32(i32 7, float %216)  ; Saturate(value)
  %217 = fmul fast float %Saturate40, 5.000000e-01
  %218 = fadd fast float %217, 5.000000e-01
  %219 = fmul fast float %218, %Exp
  %220 = load float, float* %170, align 4, !tbaa !520
  %221 = fsub fast float %220, %.i0258
  %222 = fcmp fast ogt float %221, %219
  %223 = fadd fast float %.i0255, 5.000000e-01
  %224 = fmul fast float %Exp, %223
  %225 = select i1 %222, float %224, float %.i0258
  %226 = load float, float* %171, align 4, !tbaa !520
  %227 = fsub fast float %226, %.i1259
  %228 = fcmp fast ogt float %227, %219
  %229 = fadd fast float %.i1256, 5.000000e-01
  %230 = fmul fast float %Exp, %229
  %231 = select i1 %228, float %230, float %.i1259
  %232 = load float, float* %172, align 4, !tbaa !520
  %233 = fsub fast float %232, %.i2260
  %234 = fcmp fast ogt float %233, %219
  %235 = fadd fast float %.i2257, 5.000000e-01
  %236 = fmul fast float %Exp, %235
  %237 = select i1 %234, float %236, float %.i2260
  %238 = getelementptr inbounds [3 x float], [3 x float]* %2, i32 0, i32 0
  store float %225, float* %238, align 4
  %239 = getelementptr inbounds [3 x float], [3 x float]* %2, i32 0, i32 1
  store float %231, float* %239, align 4
  %240 = getelementptr inbounds [3 x float], [3 x float]* %2, i32 0, i32 2
  store float %237, float* %240, align 4
  %241 = getelementptr [3 x float], [3 x float]* %2, i32 0, i32 %iMajorAxis.i.1
  store float 0.000000e+00, float* %241, align 4, !tbaa !520
  %242 = load float, float* %238, align 4
  %243 = load float, float* %239, align 4
  %244 = load float, float* %240, align 4
  %.i0345 = bitcast float %242 to i32
  %.i1346 = bitcast float %243 to i32
  %.i2347 = bitcast float %244 to i32
  %245 = shl i32 %.i1346, 5
  %246 = xor i32 %245, %.i1346
  %247 = shl i32 %.i2347, 13
  %248 = xor i32 %247, %.i2347
  %249 = add i32 %246, %.i0345
  %250 = add i32 %249, %248
  %251 = xor i32 %250, 61
  %252 = lshr i32 %250, 16
  %253 = xor i32 %251, %252
  ...
  %259 = xor i32 %258, %257
  %260 = lshr i32 %259, 16
  %.i0348 = fsub fast float %220, %225
  %.i1349 = fsub fast float %226, %231
  %.i2350 = fsub fast float %232, %237
  %261 = call float @dx.op.dot3.f32(i32 55, float %.i0348, float %.i1349, float %.i2350, float %.i0240, float %.i1241, float %.i2242)  ; Dot3(ax,ay,az,bx,by,bz)
  %.i0351 = fmul fast float %261, %.i0240
  %.i1352 = fmul fast float %261, %.i1241
  %.i2353 = fmul fast float %261, %.i2242
  %.i0354 = fadd fast float %.i0351, %225
  %.i1355 = fadd fast float %.i1352, %231
  %.i2356 = fadd fast float %.i2353, %237
  %262 = fmul fast float %.i0354, %152
  %FMad144 = call float @dx.op.tertiary.f32(i32 46, float %.i1355, float %156, float %262)  ; FMad(a,b,c)
  %FMad143 = call float @dx.op.tertiary.f32(i32 46, float %.i2356, float %160, float %FMad144)  ; FMad(a,b,c)
  %263 = fadd fast float %FMad143, %164
  %264 = fmul fast float %.i0354, %153
  %FMad141 = call float @dx.op.tertiary.f32(i32 46, float %.i1355, float %157, float %264)  ; FMad(a,b,c)
  %FMad140 = call float @dx.op.tertiary.f32(i32 46, float %.i2356, float %161, float %FMad141)  ; FMad(a,b,c)
  %265 = fadd fast float %FMad140, %165
  %266 = fmul fast float %.i0354, %154
  %FMad135 = call float @dx.op.tertiary.f32(i32 46, float %.i1355, float %158, float %266)  ; FMad(a,b,c)
  %FMad134 = call float @dx.op.tertiary.f32(i32 46, float %.i2356, float %162, float %FMad135)  ; FMad(a,b,c)
  %267 = fadd fast float %FMad134, %166
  %268 = fdiv fast float 1.000000e+00, %267
  %.i0357 = fmul fast float %263, 5.000000e-01
  %.i0360 = fmul fast float %.i0357, %268
  %.i1358 = fmul fast float %265, 5.000000e-01
  %.i1361 = fmul fast float %.i1358, %268
  %.i0362 = fadd fast float %.i0360, 5.000000e-01
  %.i1363455 = fsub fast float 5.000000e-01, %.i1361
  %.i0364 = fmul fast float %.i0362, %168
  %.i1365 = fmul fast float %.i1363455, %169
  ...
  %.i0370 = add i32 %.i0368, %260
  %.i1371 = add i32 %.i1369, %259
  %.i0372 = and i32 %.i0370, 255
  %.i1373 = and i32 %.i1371, 255
  %269 = call %dx.types.Handle @"dx.op.createHandleForLib.class.Texture2D<vector<float, 4> >"(i32 160, %"class.Texture2D<vector<float, 4> >" %4)  ; CreateHandleForLib(Resource)
  %TextureLoad153 = call %dx.types.ResRet.f32 @dx.op.textureLoad.f32(i32 66, %dx.types.Handle %269, i32 0, i32 %.i0372, i32 %.i1373, i32 undef, i32 undef, i32 undef, i32 undef)  ; TextureLoad(srv,mipLevelOrSampleCount,coord0,coord1,coord2,offset0,offset1,offset2)
  %.i0264 = extractvalue %dx.types.ResRet.f32 %TextureLoad153, 0
  %.i1266 = extractvalue %dx.types.ResRet.f32 %TextureLoad153, 1
  %.i2268 = extractvalue %dx.types.ResRet.f32 %TextureLoad153, 2
  %270 = icmp sgt i32 %141, 0
  br i1 %270, label %.lr.ph30.preheader, label %._crit_edge.31

.lr.ph30:                                         ; preds = %.lr.ph30.preheader, %376
  %reflectionRayIndex.029 = phi i32 [ %379, %376 ], [ 0, %.lr.ph30.preheader ]
  %271 = call %dx.types.CBufRet.i32 @dx.op.cbufferLoadLegacy.i32(i32 59, %dx.types.Handle %sys_constants, i32 69)  ; CBufferLoadLegacy(handle,regIndex)
  %272 = extractvalue %dx.types.CBufRet.i32 %271, 1
  %273 = mul i32 %272, %141
  %274 = add i32 %273, %reflectionRayIndex.029
  %275 = uitofp i32 %274 to float
  %.i0261 = fmul fast float %275, 0x3FE827F540000000
  %.i1262 = fmul fast float %275, 0x3FE23C21C0000000
  %.i2263 = fmul fast float %275, 0x3FF9E377A0000000
  %.i0265 = fadd fast float %.i0261, %.i0264
  %.i1267 = fadd fast float %.i1262, %.i1266
  %.i2269 = fadd fast float %.i2263, %.i2268
  %Frc63 = call float @dx.op.unary.f32(i32 22, float %.i0265)  ; Frc(value)
  %Frc64 = call float @dx.op.unary.f32(i32 22, float %.i1267)  ; Frc(value)
  %Frc65 = call float @dx.op.unary.f32(i32 22, float %.i2269)  ; Frc(value)
  %.i1271 = fmul fast float %Frc64, 0x3FD99999A0000000
  %276 = fmul fast float %Frc63, 0x401921FB60000000
  %277 = fsub fast float 1.000000e+00, %.i1271
  %278 = fmul fast float %.i1271, %384
  %279 = fadd fast float %278, 1.000000e+00
  %280 = fdiv fast float %277, %279
  %Saturate39 = call float @dx.op.unary.f32(i32 7, float %280)  ; Saturate(value)
  %Sqrt38 = call float @dx.op.unary.f32(i32 24, float %Saturate39)  ; Sqrt(value)
  %281 = fmul fast float %Sqrt38, %Sqrt38
  %282 = fsub fast float 1.000000e+00, %281
  %Sqrt37 = call float @dx.op.unary.f32(i32 24, float %282)  ; Sqrt(value)
  %Sin36 = call float @dx.op.unary.f32(i32 13, float %276)  ; Sin(value)
  %Cos35 = call float @dx.op.unary.f32(i32 12, float %276)  ; Cos(value)
  %283 = fmul fast float %Cos35, %Sqrt37
  %284 = fmul fast float %Sin36, %Sqrt37
  br i1 %385, label %"\01?internal.getImportanceRay@@YA?AV?$vector@M$02@@V1@0MV?$vector@M$01@@@Z.exit", label %285

; <label>:285                                     ; preds = %.lr.ph30
  br label %"\01?internal.getImportanceRay@@YA?AV?$vector@M$02@@V1@0MV?$vector@M$01@@@Z.exit"

"\01?internal.getImportanceRay@@YA?AV?$vector@M$02@@V1@0MV?$vector@M$01@@@Z.exit": ; preds = %285, %.lr.ph30
  %.025.i0 = phi float [ %395, %285 ], [ -1.000000e+00, %.lr.ph30 ]
  %.025.i1 = phi float [ %402, %285 ], [ 0.000000e+00, %.lr.ph30 ]
  %.025.i2 = phi float [ %403, %285 ], [ 0.000000e+00, %.lr.ph30 ]
  %.024.i0 = phi float [ %398, %285 ], [ 0.000000e+00, %.lr.ph30 ]
  %.024.i2 = phi float [ %399, %285 ], [ 0.000000e+00, %.lr.ph30 ]
  %.i0276 = fmul fast float %.024.i0, %283
  %.i1277 = fmul fast float %.025.i0, %283
  %.i2278 = fmul fast float %.024.i2, %283
  %.i0279 = fmul fast float %.025.i0, %284
  %.i1280 = fmul fast float %.025.i1, %284
  %.i2281 = fmul fast float %.025.i2, %284
  %.i0285 = fmul fast float %Sqrt38, %.i0212
  %.i1286 = fmul fast float %Sqrt38, %.i1213
  %.i2287 = fmul fast float %Sqrt38, %.i2214
  %.i0282 = fadd fast float %.i0279, %.i0285
  %.i0288 = fadd fast float %.i0282, %.i0276
  %.i1283 = fadd fast float %.i1277, %.i1286
  %.i1289 = fadd fast float %.i1283, %.i1280
  %.i2284 = fadd fast float %.i2281, %.i2287
  %.i2290 = fadd fast float %.i2284, %.i2278
  %286 = call float @dx.op.dot3.f32(i32 55, float %.i0273, float %.i1274, float %.i2275, float %.i0288, float %.i1289, float %.i2290)  ; Dot3(ax,ay,az,bx,by,bz)
  %287 = fmul fast float %286, 2.000000e+00
  %.i0291 = fmul fast float %287, %.i0288
  %.i1292 = fmul fast float %287, %.i1289
  %.i2293 = fmul fast float %.i2290, %287
  %.i0294 = fadd fast float %.i0291, %.i0166
  %.i1295 = fadd fast float %.i1292, %.i1167
  %.i2296 = fadd fast float %.i2293, %.i2168
  %288 = fmul fast float %.i0294, %.i0294
  %289 = fmul fast float %.i1295, %.i1295
  %290 = fadd fast float %288, %289
  %291 = fmul fast float %.i2296, %.i2296
  %292 = fadd fast float %290, %291
  %Sqrt69 = call float @dx.op.unary.f32(i32 24, float %292)  ; Sqrt(value)
  %.i0297 = fdiv fast float %.i0294, %Sqrt69
  %.i1298 = fdiv fast float %.i1295, %Sqrt69
  %.i2299 = fdiv fast float %.i2296, %Sqrt69
  %293 = call float @dx.op.dot3.f32(i32 55, float %.i0297, float %.i1298, float %.i2299, float %.i0212, float %.i1213, float %.i2214)  ; Dot3(ax,ay,az,bx,by,bz)
  %294 = fcmp fast olt float %293, 0x3F747AE140000000
...
.lr.ph.preheader:                                 ; preds = %"\01?internal.getImportanceRay@@YA?AV?$vector@M$02@@V1@0MV?$vector@M$01@@@Z.exit"
  %295 = uitofp i32 %272 to float
  br label %.lr.ph

.lr.ph:                                           ; preds = %"\01?internal.getImportanceRay@@YA?AV?$vector@M$02@@V1@0MV?$vector@M$01@@@Z.exit13", %.lr.ph.preheader
  %i.028 = phi i32 [ %296, %"\01?internal.getImportanceRay@@YA?AV?$vector@M$02@@V1@0MV?$vector@M$01@@@Z.exit13" ], [ 0, %.lr.ph.preheader ]
  %296 = add nuw nsw i32 %i.028, 1
  %297 = uitofp i32 %296 to float
  %298 = fmul fast float %297, 1.000000e+01
  %299 = fadd fast float %298, %295
  %.i0300 = fmul fast float %299, 0x3FE827F540000000
  %.i1301 = fmul fast float %299, 0x3FE23C21C0000000
  %.i0302 = fadd fast float %.i0300, %.i0264
  %.i1303 = fadd fast float %.i1301, %.i1266
  %Frc = call float @dx.op.unary.f32(i32 22, float %.i0302)  ; Frc(value)
  %Frc47 = call float @dx.op.unary.f32(i32 22, float %.i1303)  ; Frc(value)
  %.i1305 = fmul fast float %Frc47, 0x3FD99999A0000000
  %300 = fmul fast float %Frc, 0x401921FB60000000
  %301 = fsub fast float 1.000000e+00, %.i1305
  %302 = fmul fast float %.i1305, %384
  %303 = fadd fast float %302, 1.000000e+00
  %304 = fdiv fast float %301, %303
  %Saturate = call float @dx.op.unary.f32(i32 7, float %304)  ; Saturate(value)
  %Sqrt34 = call float @dx.op.unary.f32(i32 24, float %Saturate)  ; Sqrt(value)
  %305 = fmul fast float %Sqrt34, %Sqrt34
  %306 = fsub fast float 1.000000e+00, %305
  %Sqrt = call float @dx.op.unary.f32(i32 24, float %306)  ; Sqrt(value)
  %Sin = call float @dx.op.unary.f32(i32 13, float %300)  ; Sin(value)
  %Cos = call float @dx.op.unary.f32(i32 12, float %300)  ; Cos(value)
  %307 = fmul fast float %Cos, %Sqrt
  %308 = fmul fast float %Sin, %Sqrt
  br i1 %385, label %"\01?internal.getImportanceRay@@YA?AV?$vector@M$02@@V1@0MV?$vector@M$01@@@Z.exit13", label %309

; <label>:309                                     ; preds = %.lr.ph
  br label %"\01?internal.getImportanceRay@@YA?AV?$vector@M$02@@V1@0MV?$vector@M$01@@@Z.exit13"

"\01?internal.getImportanceRay@@YA?AV?$vector@M$02@@V1@0MV?$vector@M$01@@@Z.exit13": ; preds = %309, %.lr.ph
  %.027.i0 = phi float [ %395, %309 ], [ -1.000000e+00, %.lr.ph ]
  %.027.i1 = phi float [ %402, %309 ], [ 0.000000e+00, %.lr.ph ]
  %.027.i2 = phi float [ %403, %309 ], [ 0.000000e+00, %.lr.ph ]
  %.026.i0 = phi float [ %398, %309 ], [ 0.000000e+00, %.lr.ph ]
  %.026.i2 = phi float [ %399, %309 ], [ 0.000000e+00, %.lr.ph ]
  %.i0309 = fmul fast float %.026.i0, %307
  %.i1310 = fmul fast float %.027.i0, %307
  %.i2311 = fmul fast float %.026.i2, %307
  %.i0312 = fmul fast float %.027.i0, %308
  %.i1313 = fmul fast float %.027.i1, %308
  %.i2314 = fmul fast float %.027.i2, %308
  %.i0318 = fmul fast float %Sqrt34, %.i0212
  %.i1319 = fmul fast float %Sqrt34, %.i1213
  %.i2320 = fmul fast float %Sqrt34, %.i2214
  %.i0315 = fadd fast float %.i0312, %.i0318
  %.i0321 = fadd fast float %.i0315, %.i0309
  %.i1316 = fadd fast float %.i1310, %.i1319
  %.i1322 = fadd fast float %.i1316, %.i1313
  %.i2317 = fadd fast float %.i2314, %.i2320
  %.i2323 = fadd fast float %.i2317, %.i2311
  %310 = call float @dx.op.dot3.f32(i32 55, float %.i0273, float %.i1274, float %.i2275, float %.i0321, float %.i1322, float %.i2323)  ; Dot3(ax,ay,az,bx,by,bz)
  %311 = fmul fast float %310, 2.000000e+00
  %.i0324 = fmul fast float %311, %.i0321
  %.i1325 = fmul fast float %311, %.i1322
  %.i2326 = fmul fast float %.i2323, %311
  %.i0327 = fadd fast float %.i0324, %.i0166
  %.i1328 = fadd fast float %.i1325, %.i1167
  %.i2329 = fadd fast float %.i2326, %.i2168
  %312 = fmul fast float %.i0327, %.i0327
  %313 = fmul fast float %.i1328, %.i1328
  %314 = fadd fast float %312, %313
  %315 = fmul fast float %.i2329, %.i2329
  %316 = fadd fast float %314, %315
  %Sqrt70 = call float @dx.op.unary.f32(i32 24, float %316)  ; Sqrt(value)
  %.i0330 = fdiv fast float %.i0327, %Sqrt70
  %.i1331 = fdiv fast float %.i1328, %Sqrt70
  %.i2332 = fdiv fast float %.i2329, %Sqrt70
  %317 = call float @dx.op.dot3.f32(i32 55, float %.i0330, float %.i1331, float %.i2332, float %.i0212, float %.i1213, float %.i2214)  ; Dot3(ax,ay,az,bx,by,bz)
  %318 = fcmp fast olt float %317, 0x3F747AE140000000
  %319 = icmp ult i32 %296, 100
  %320 = and i1 %319, %318
  br i1 %320, label %.lr.ph, label %._crit_edge.loopexit

._crit_edge.loopexit:                             ; preds = %"\01?internal.getImportanceRay@@YA?AV?$vector@M$02@@V1@0MV?$vector@M$01@@@Z.exit13"
  %.i2332.lcssa = phi float [ %.i2332, %"\01?internal.getImportanceRay@@YA?AV?$vector@M$02@@V1@0MV?$vector@M$01@@@Z.exit13" ]
  %.i1331.lcssa = phi float [ %.i1331, %"\01?internal.getImportanceRay@@YA?AV?$vector@M$02@@V1@0MV?$vector@M$01@@@Z.exit13" ]
  %.i0330.lcssa = phi float [ %.i0330, %"\01?internal.getImportanceRay@@YA?AV?$vector@M$02@@V1@0MV?$vector@M$01@@@Z.exit13" ]
  br label %._crit_edge

._crit_edge:                                      ; preds = %._crit_edge.loopexit, %"\01?internal.getImportanceRay@@YA?AV?$vector@M$02@@V1@0MV?$vector@M$01@@@Z.exit"
  %vReflectionDirectionInView.0.lcssa.i0 = phi float [ %.i0297, %"\01?internal.getImportanceRay@@YA?AV?$vector@M$02@@V1@0MV?$vector@M$01@@@Z.exit" ], [ %.i0330.lcssa, %._crit_edge.loopexit ]
  %vReflectionDirectionInView.0.lcssa.i1 = phi float [ %.i1298, %"\01?internal.getImportanceRay@@YA?AV?$vector@M$02@@V1@0MV?$vector@M$01@@@Z.exit" ], [ %.i1331.lcssa, %._crit_edge.loopexit ]
  %vReflectionDirectionInView.0.lcssa.i2 = phi float [ %.i2299, %"\01?internal.getImportanceRay@@YA?AV?$vector@M$02@@V1@0MV?$vector@M$01@@@Z.exit" ], [ %.i2332.lcssa, %._crit_edge.loopexit ]
  %321 = call %dx.types.CBufRet.f32 @dx.op.cbufferLoadLegacy.f32(i32 59, %dx.types.Handle %sys_constants, i32 6)  ; CBufferLoadLegacy(handle,regIndex)
  ...
  %325 = call %dx.types.CBufRet.f32 @dx.op.cbufferLoadLegacy.f32(i32 59, %dx.types.Handle %sys_constants, i32 7)  ; CBufferLoadLegacy(handle,regIndex)
  ...
  %329 = call %dx.types.CBufRet.f32 @dx.op.cbufferLoadLegacy.f32(i32 59, %dx.types.Handle %sys_constants, i32 8)  ; CBufferLoadLegacy(handle,regIndex)
  ...
  %FMad78 = call float @dx.op.tertiary.f32(i32 46, float %vReflectionDirectionInView.0.lcssa.i1, float %326, float %333)  ; FMad(a,b,c)
  %FMad77 = call float @dx.op.tertiary.f32(i32 46, float %vReflectionDirectionInView.0.lcssa.i2, float %330, float %FMad78)  ; FMad(a,b,c)
  %334 = insertelement <3 x float> undef, float %FMad77, i64 0
  %335 = fmul fast float %323, %vReflectionDirectionInView.0.lcssa.i0
  %FMad76 = call float @dx.op.tertiary.f32(i32 46, float %vReflectionDirectionInView.0.lcssa.i1, float %327, float %335)  ; FMad(a,b,c)
  %FMad75 = call float @dx.op.tertiary.f32(i32 46, float %vReflectionDirectionInView.0.lcssa.i2, float %331, float %FMad76)  ; FMad(a,b,c)
  %336 = insertelement <3 x float> %334, float %FMad75, i64 1
  %337 = fmul fast float %324, %vReflectionDirectionInView.0.lcssa.i0
  %FMad74 = call float @dx.op.tertiary.f32(i32 46, float %vReflectionDirectionInView.0.lcssa.i1, float %328, float %337)  ; FMad(a,b,c)
  %FMad = call float @dx.op.tertiary.f32(i32 46, float %vReflectionDirectionInView.0.lcssa.i2, float %332, float %FMad74)  ; FMad(a,b,c)
  %338 = insertelement <3 x float> %336, float %FMad, i64 2
  %339 = fadd fast float %Frc65, 5.000000e-01
  %340 = fmul fast float %387, %339
  %341 = fadd fast float %340, %387
  store i32 %reflectionRayIndex.029, i32* %388, align 8
  %342 = call %dx.types.Handle @dx.op.createHandleForLib.struct.RaytracingAccelerationStructure(i32 160, %struct.RaytracingAccelerationStructure %3)  ; CreateHandleForLib(Resource)
  %343 = load <3 x float>, <3 x float>* %138, align 4
  %344 = extractelement <3 x float> %343, i64 0
  %345 = extractelement <3 x float> %343, i64 1
  %346 = extractelement <3 x float> %343, i64 2
  call void @dx.op.traceRay.struct.HitData(i32 157, %dx.types.Handle %342, i32 0, i32 1, i32 0, i32 2, i32 0, float %344, float %345, float %346, float %389, float %FMad77, float %FMad75, float %FMad, float %341, %struct.HitData* nonnull %12)  ; TraceRay(AccelerationStructure,RayFlags,InstanceInclusionMask,RayContributionToHitGroupIndex,MultiplierForGeometryContributionToShaderIndex,MissShaderIndex,Origin_X,Origin_Y,Origin_Z,TMin,Direction_X,Direction_Y,Direction_Z,TMax,payload)
  %347 = load i32, i32* %388, align 8
  %348 = icmp eq i32 %347, 0
  br i1 %348, label %376, label %349

; <label>:349                                     ; preds = %._crit_edge
  %350 = uitofp i32 %347 to float
  %351 = fmul fast float %350, 0x3F1A36E2E0000000
  %.i0334 = fmul fast float %FMad77, %351
  %.i1336 = fmul fast float %FMad75, %351
  %.i2338 = fmul fast float %FMad, %351
  %.i0339 = extractelement <3 x float> %343, i32 0
  %.i0340 = fadd fast float %.i0339, %.i0334
  %.i1341 = extractelement <3 x float> %343, i32 1
  %.i1342 = fadd fast float %.i1341, %.i1336
  %.i2343 = extractelement <3 x float> %343, i32 2
  ...
  %352 = insertelement <3 x float> %.upto1438, float %.i2344, i32 2
  store <3 x float> %352, <3 x float>* %138, align 4, !tbaa !517
  %353 = call %dx.types.Handle @"dx.op.createHandleForLib.class.StructuredBuffer<DeferredLightSun>"(i32 160, %"class.StructuredBuffer<DeferredLightSun>" %5)  ; CreateHandleForLib(Resource)
  %RawBufferLoad = call %dx.types.ResRet.f32 @dx.op.rawBufferLoad.f32(i32 139, %dx.types.Handle %353, i32 0, i32 0, i8 7, i32 4)  ; RawBufferLoad(srv,index,elementOffset,mask,alignment)
  %354 = extractvalue %dx.types.ResRet.f32 %RawBufferLoad, 0
  %355 = extractvalue %dx.types.ResRet.f32 %RawBufferLoad, 1
  %356 = extractvalue %dx.types.ResRet.f32 %RawBufferLoad, 2
  %357 = call %dx.types.CBufRet.f32 @dx.op.cbufferLoadLegacy.f32(i32 59, %dx.types.Handle %sys_constants, i32 6)  ; CBufferLoadLegacy(handle,regIndex)
  ...
  %361 = call %dx.types.CBufRet.f32 @dx.op.cbufferLoadLegacy.f32(i32 59, %dx.types.Handle %sys_constants, i32 7)  ; CBufferLoadLegacy(handle,regIndex)
  ...
  %365 = call %dx.types.CBufRet.f32 @dx.op.cbufferLoadLegacy.f32(i32 59, %dx.types.Handle %sys_constants, i32 8)  ; CBufferLoadLegacy(handle,regIndex)
  ...
  %369 = fmul fast float %358, %354
  %FMad132 = call float @dx.op.tertiary.f32(i32 46, float %355, float %362, float %369)  ; FMad(a,b,c)
  %FMad131 = call float @dx.op.tertiary.f32(i32 46, float %356, float %366, float %FMad132)  ; FMad(a,b,c)
  %370 = insertelement <3 x float> undef, float %FMad131, i64 0
  %371 = fmul fast float %359, %354
  %FMad130 = call float @dx.op.tertiary.f32(i32 46, float %355, float %363, float %371)  ; FMad(a,b,c)
  %FMad129 = call float @dx.op.tertiary.f32(i32 46, float %356, float %367, float %FMad130)  ; FMad(a,b,c)
  %372 = insertelement <3 x float> %370, float %FMad129, i64 1
  %373 = fmul fast float %360, %354
  %FMad128 = call float @dx.op.tertiary.f32(i32 46, float %355, float %364, float %373)  ; FMad(a,b,c)
  %FMad127 = call float @dx.op.tertiary.f32(i32 46, float %356, float %368, float %FMad128)  ; FMad(a,b,c)
  %374 = insertelement <3 x float> %372, float %FMad127, i64 2
  store i32 %reflectionRayIndex.029, i32* %390, align 8
  %375 = call %dx.types.Handle @dx.op.createHandleForLib.struct.RaytracingAccelerationStructure(i32 160, %struct.RaytracingAccelerationStructure %3)  ; CreateHandleForLib(Resource)
  call void @dx.op.traceRay.struct.HitData(i32 157, %dx.types.Handle %375, i32 4, i32 1, i32 1, i32 2, i32 1, float %.i0340, float %.i1342, float %.i2344, float %389, float %FMad131, float %FMad129, float %FMad127, float 1.000000e+03, %struct.HitData* nonnull %11)  ; TraceRay(AccelerationStructure,RayFlags,InstanceInclusionMask,RayContributionToHitGroupIndex,MultiplierForGeometryContributionToShaderIndex,MissShaderIndex,Origin_X,Origin_Y,Origin_Z,TMin,Direction_X,Direction_Y,Direction_Z,TMax,payload)
  br label %376

; <label>:376                                     ; preds = %349, %._crit_edge
  %377 = phi float [ %341, %._crit_edge ], [ 1.000000e+03, %349 ]
  %378 = phi <3 x float> [ %338, %._crit_edge ], [ %374, %349 ]
  %379 = add nuw nsw i32 %reflectionRayIndex.029, 1
  %exitcond = icmp eq i32 %379, %141
  br i1 %exitcond, label %._crit_edge.31.loopexit, label %.lr.ph30

._crit_edge.31.loopexit:                          ; preds = %376
  %.lcssa461 = phi <3 x float> [ %378, %376 ]
  %.lcssa = phi float [ %377, %376 ]
  %380 = getelementptr inbounds %struct.RayDesc, %struct.RayDesc* %ray, i32 0, i32 2
  %381 = getelementptr inbounds %struct.RayDesc, %struct.RayDesc* %ray, i32 0, i32 3
  store <3 x float> %.lcssa461, <3 x float>* %380, align 4
  store float %.lcssa, float* %381, align 4
...
.lr.ph30.preheader:                               ; preds = %"\01?internal.getWorldSpaceNoiseOffset@@YA?AV?$vector@I$01@@V?$vector@M$01@@V?$matrix@M$03$03@@10MV?$vector@M$02@@22M_N@Z.exit33"
  ...
  %382 = fmul fast float %136, %136
  %383 = fmul fast float %382, %382
  %384 = fadd fast float %383, -1.000000e+00
  %385 = fcmp fast olt float %.i2214, 0xBFEFFFFFC0000000
  %Saturate44 = call float @dx.op.unary.f32(i32 7, float %136)  ; Saturate(value)
  %Sqrt45 = call float @dx.op.unary.f32(i32 24, float %Saturate44)  ; Sqrt(value)
  %386 = fmul fast float %Sqrt45, 6.000000e+00
  %Exp43 = call float @dx.op.unary.f32(i32 21, float %386)  ; Exp(value)
  %387 = fdiv fast float 0x4066666660000000, %Exp43
  %388 = getelementptr inbounds %struct.HitData, %struct.HitData* %12, i32 0, i32 0
  %389 = load float, float* %139, align 4
  %390 = getelementptr inbounds %struct.HitData, %struct.HitData* %11, i32 0, i32 0
  %391 = fadd fast float %.i2214, 1.000000e+00
  %392 = fdiv fast float 1.000000e+00, %391
  %393 = fmul fast float %.i0212, %.i1213
  %394 = fmul fast float %393, %392
  %395 = fsub fast float -0.000000e+00, %394
  %396 = fmul fast float %.i0212, %.i0212
  %397 = fmul fast float %396, %392
  %398 = fsub fast float 1.000000e+00, %397
  %399 = fsub fast float -0.000000e+00, %.i0212
  %400 = fmul fast float %.i1213, %.i1213
  %401 = fmul fast float %400, %392
  %402 = fsub fast float 1.000000e+00, %401
  %403 = fsub fast float -0.000000e+00, %.i1213
  br label %.lr.ph30
}
