...
"\01?internal.getRaytracingVertexIndices@@YA?AV?$vector@I$02@@I@Z.exit": ; preds = %35, %22
  ...
  %126 = load i32, i32* %125, align 4, !tbaa !541
  ...
  store i32 %131, i32* %125, align 4, !tbaa !541
  ret void
}
...
define void @"\01?reflectionRayGeneration@@YAXXZ"() #0 {
  ...
  %FMad160 = call float @dx.op.tertiary.f32(i32 46, float %.i1180508, float %34, float %48)  ; FMad(a,b,c)
  %FMad159 = call float @dx.op.tertiary.f32(i32 46, float %25, float %39, float %FMad160)  ; FMad(a,b,c)
  %49 = fadd fast float %FMad159, %44
  %50 = fmul fast float %30, %.i0179
  %FMad157 = call float @dx.op.tertiary.f32(i32 46, float %.i1180508, float %35, float %50)  ; FMad(a,b,c)
  %FMad156 = call float @dx.op.tertiary.f32(i32 46, float %25, float %40, float %FMad157)  ; FMad(a,b,c)
  %51 = fadd fast float %FMad156, %45
  %52 = fmul fast float %31, %.i0179
  %FMad154 = call float @dx.op.tertiary.f32(i32 46, float %.i1180508, float %36, float %52)  ; FMad(a,b,c)
  %FMad153 = call float @dx.op.tertiary.f32(i32 46, float %25, float %41, float %FMad154)  ; FMad(a,b,c)
  %53 = fadd fast float %FMad153, %46
  %54 = fmul fast float %32, %.i0179
  %FMad151 = call float @dx.op.tertiary.f32(i32 46, float %.i1180508, float %37, float %54)  ; FMad(a,b,c)
  %FMad150 = call float @dx.op.tertiary.f32(i32 46, float %25, float %42, float %FMad151)  ; FMad(a,b,c)
  %55 = fadd fast float %FMad150, %47
  ...
  %FMad94 = call float @dx.op.tertiary.f32(i32 46, float %.i1180508, float %68, float %82)  ; FMad(a,b,c)
  %FMad93 = call float @dx.op.tertiary.f32(i32 46, float %25, float %73, float %FMad94)  ; FMad(a,b,c)
  %83 = fadd fast float %FMad93, %78
  %84 = fmul fast float %64, %.i0179
  %FMad91 = call float @dx.op.tertiary.f32(i32 46, float %.i1180508, float %69, float %84)  ; FMad(a,b,c)
  %FMad90 = call float @dx.op.tertiary.f32(i32 46, float %25, float %74, float %FMad91)  ; FMad(a,b,c)
  %85 = fadd fast float %FMad90, %79
  %86 = fmul fast float %65, %.i0179
  %FMad88 = call float @dx.op.tertiary.f32(i32 46, float %.i1180508, float %70, float %86)  ; FMad(a,b,c)
  %FMad87 = call float @dx.op.tertiary.f32(i32 46, float %25, float %75, float %FMad88)  ; FMad(a,b,c)
  %87 = fadd fast float %FMad87, %80
  %88 = fmul fast float %66, %.i0179
  %FMad85 = call float @dx.op.tertiary.f32(i32 46, float %.i1180508, float %71, float %88)  ; FMad(a,b,c)
  %FMad84 = call float @dx.op.tertiary.f32(i32 46, float %25, float %76, float %FMad85)  ; FMad(a,b,c)
  %89 = fadd fast float %FMad84, %81
  ...
  %FMad112 = call float @dx.op.tertiary.f32(i32 46, float %.i1230, float %131, float %138)  ; FMad(a,b,c)
  %FMad111 = call float @dx.op.tertiary.f32(i32 46, float %.i2231, float %135, float %FMad112)  ; FMad(a,b,c)
  %139 = fmul fast float %128, %.i0229
  %FMad110 = call float @dx.op.tertiary.f32(i32 46, float %.i1230, float %132, float %139)  ; FMad(a,b,c)
  %FMad109 = call float @dx.op.tertiary.f32(i32 46, float %.i2231, float %136, float %FMad110)  ; FMad(a,b,c)
  %140 = fmul fast float %129, %.i0229
  %FMad108 = call float @dx.op.tertiary.f32(i32 46, float %.i1230, float %133, float %140)  ; FMad(a,b,c)
  %FMad107 = call float @dx.op.tertiary.f32(i32 46, float %.i2231, float %137, float %FMad108)  ; FMad(a,b,c)
  ...
  %.i0244 = fmul fast float %.i0232, %FMad111
  %.i1245 = fmul fast float %.i0232, %FMad109
  %.i2246 = fmul fast float %.i0232, %FMad107
  ...
  store <3 x float> %141, <3 x float>* %142, align 4, !tbaa !533
  %143 = getelementptr inbounds %struct.RayDesc, %struct.RayDesc* %ray, i32 0, i32 1
  store float 0.000000e+00, float* %143, align 4, !tbaa !548
...
"\01?internal.getMaterialSpecular@@YA?AV?$vector@M$02@@IM@Z.exit": ; preds = %166, %0
  ...
  %171 = call float @dx.op.dot3.f32(i32 55, float %FMad111, float %FMad109, float %FMad107, float %.i0268, float %.i1269, float %.i2270)  ; Dot3(ax,ay,az,bx,by,bz)
...
"\01?internal.getReflectionRayCount@@YAHV?$vector@M$02@@M@Z.exit": ; preds = %180, %"\01?internal.getMaterialSpecular@@YA?AV?$vector@M$02@@IM@Z.exit"
  ...
  %.i0284 = fmul fast float %FMad111, 4.000000e+00
  %.i1285 = fmul fast float %FMad109, 4.000000e+00
  %.i2286 = fmul fast float %FMad107, 4.000000e+00
  ...
  %FMad120 = call float @dx.op.tertiary.f32(i32 46, float %25, float %197, float 0.000000e+00)  ; FMad(a,b,c)
  %231 = fadd fast float %FMad120, %200
  %FMad114 = call float @dx.op.tertiary.f32(i32 46, float %25, float %198, float 0.000000e+00)  ; FMad(a,b,c)
  %232 = fadd fast float %FMad114, %201
  %233 = fdiv fast float 1.000000e+00, %232
  %.i1291 = fmul fast float %233, %231
  %234 = fdiv fast float 2.000000e+00, %220
  %FMad103 = call float @dx.op.tertiary.f32(i32 46, float %234, float %194, float 0.000000e+00)  ; FMad(a,b,c)
  %FMad102 = call float @dx.op.tertiary.f32(i32 46, float %25, float %197, float %FMad103)  ; FMad(a,b,c)
  %235 = fadd fast float %FMad102, %200
  %FMad97 = call float @dx.op.tertiary.f32(i32 46, float %234, float %195, float 0.000000e+00)  ; FMad(a,b,c)
  %FMad96 = call float @dx.op.tertiary.f32(i32 46, float %25, float %198, float %FMad97)  ; FMad(a,b,c)
  %236 = fadd fast float %FMad96, %201
  ...
  store i32 0, i32* %243, align 4, !tbaa !541
  ...
  %271 = load float, float* %221, align 4, !tbaa !548
  ...
  %277 = load float, float* %222, align 4, !tbaa !548
  ...
  %283 = load float, float* %223, align 4, !tbaa !548
  ...
  store float 0.000000e+00, float* %292, align 4, !tbaa !548
  ...
  %FMad148 = call float @dx.op.tertiary.f32(i32 46, float %.i1402, float %207, float %313)  ; FMad(a,b,c)
  %FMad147 = call float @dx.op.tertiary.f32(i32 46, float %.i2403, float %211, float %FMad148)  ; FMad(a,b,c)
  %314 = fadd fast float %FMad147, %215
  %315 = fmul fast float %.i0401, %204
  %FMad145 = call float @dx.op.tertiary.f32(i32 46, float %.i1402, float %208, float %315)  ; FMad(a,b,c)
  %FMad144 = call float @dx.op.tertiary.f32(i32 46, float %.i2403, float %212, float %FMad145)  ; FMad(a,b,c)
  %316 = fadd fast float %FMad144, %216
  %317 = fmul fast float %.i0401, %205
  %FMad139 = call float @dx.op.tertiary.f32(i32 46, float %.i1402, float %209, float %317)  ; FMad(a,b,c)
  %FMad138 = call float @dx.op.tertiary.f32(i32 46, float %.i2403, float %213, float %FMad139)  ; FMad(a,b,c)
  %318 = fadd fast float %FMad138, %217
...
._crit_edge:                                      ; preds = %.lr.ph, %.lr.ph31
  ...
  %FMad130 = call float @dx.op.tertiary.f32(i32 46, float %.i1345, float %332, float %339)  ; FMad(a,b,c)
  %FMad129 = call float @dx.op.tertiary.f32(i32 46, float %.i2346, float %336, float %FMad130)  ; FMad(a,b,c)
  %340 = insertelement <3 x float> undef, float %FMad129, i64 0
  %341 = fmul fast float %329, %.i0344
  %FMad128 = call float @dx.op.tertiary.f32(i32 46, float %.i1345, float %333, float %341)  ; FMad(a,b,c)
  %FMad127 = call float @dx.op.tertiary.f32(i32 46, float %.i2346, float %337, float %FMad128)  ; FMad(a,b,c)
  %342 = insertelement <3 x float> %340, float %FMad127, i64 1
  %343 = fmul fast float %330, %.i0344
  %FMad126 = call float @dx.op.tertiary.f32(i32 46, float %.i1345, float %334, float %343)  ; FMad(a,b,c)
  %FMad125 = call float @dx.op.tertiary.f32(i32 46, float %.i2346, float %338, float %FMad126)  ; FMad(a,b,c)
  %344 = insertelement <3 x float> %342, float %FMad125, i64 2
  ...
  call void @dx.op.traceRay.struct.HitData(i32 157, %dx.types.Handle %348, i32 0, i32 1, i32 0, i32 2, i32 0, float %350, float %351, float %352, float %389, float %FMad129, float %FMad127, float %FMad125, float %347, %struct.HitData* nonnull %18)  ; TraceRay(AccelerationStructure,RayFlags,InstanceInclusionMask,RayContributionToHitGroupIndex,MultiplierForGeometryContributionToShaderIndex,MissShaderIndex,Origin_X,Origin_Y,Origin_Z,TMin,Direction_X,Direction_Y,Direction_Z,TMax,payload)
...
; <label>:355                                     ; preds = %._crit_edge
  ...
  %.i0381 = fmul fast float %FMad129, %357
  %.i1383 = fmul fast float %FMad127, %357
  %.i2385 = fmul fast float %FMad125, %357
  ...
  store <3 x float> %358, <3 x float>* %142, align 4, !tbaa !533
  ...
  %FMad136 = call float @dx.op.tertiary.f32(i32 46, float %361, float %368, float %375)  ; FMad(a,b,c)
  %FMad135 = call float @dx.op.tertiary.f32(i32 46, float %362, float %372, float %FMad136)  ; FMad(a,b,c)
  %376 = insertelement <3 x float> undef, float %FMad135, i64 0
  %377 = fmul fast float %365, %360
  %FMad134 = call float @dx.op.tertiary.f32(i32 46, float %361, float %369, float %377)  ; FMad(a,b,c)
  %FMad133 = call float @dx.op.tertiary.f32(i32 46, float %362, float %373, float %FMad134)  ; FMad(a,b,c)
  %378 = insertelement <3 x float> %376, float %FMad133, i64 1
  %379 = fmul fast float %366, %360
  %FMad132 = call float @dx.op.tertiary.f32(i32 46, float %361, float %370, float %379)  ; FMad(a,b,c)
  %FMad131 = call float @dx.op.tertiary.f32(i32 46, float %362, float %374, float %FMad132)  ; FMad(a,b,c)
  %380 = insertelement <3 x float> %378, float %FMad131, i64 2
  ...
  call void @dx.op.traceRay.struct.HitData(i32 157, %dx.types.Handle %381, i32 4, i32 1, i32 1, i32 2, i32 1, float %.i0387, float %.i1389, float %.i2391, float %389, float %FMad135, float %FMad133, float %FMad131, float 1.000000e+03, %struct.HitData* nonnull %17)  ; TraceRay(AccelerationStructure,RayFlags,InstanceInclusionMask,RayContributionToHitGroupIndex,MultiplierForGeometryContributionToShaderIndex,MissShaderIndex,Origin_X,Origin_Y,Origin_Z,TMin,Direction_X,Direction_Y,Direction_Z,TMax,payload)
  br label %382
...
!28 = !{i32 3, %"class.RWTexture2DArray<unsigned int>"* @"\01?g_rwtShadow@@3V?$RWTexture2DArray@I@@A", !"g_rwtShadow", i32 0, i32 3, i32 1, i32 7, i1 false, i1 false, i1 false, !25}
!29 = !{!30, !31, !32}
