...
"\01?internal.getWorldSpaceNoiseOffset@@YA?AV?$vector@I$01@@V?$vector@M$01@@V?$matrix@M$03$03@@10MV?$vector@M$02@@22M_N@Z.exit33":
  ...
  %FMad114 = call float @dx.op.tertiary.f32(i32 46, float %.i1157433, float %26, float %40)  ; FMad(a,b,c)
  %FMad113 = call float @dx.op.tertiary.f32(i32 46, float %17, float %31, float %FMad114)  ; FMad(a,b,c)
  %41 = fadd fast float %FMad113, %36
  %42 = fmul fast float %22, %.i0156
  %FMad111 = call float @dx.op.tertiary.f32(i32 46, float %.i1157433, float %27, float %42)  ; FMad(a,b,c)
  %FMad110 = call float @dx.op.tertiary.f32(i32 46, float %17, float %32, float %FMad111)  ; FMad(a,b,c)
  %43 = fadd fast float %FMad110, %37
  %44 = fmul fast float %23, %.i0156
  %FMad108 = call float @dx.op.tertiary.f32(i32 46, float %.i1157433, float %28, float %44)  ; FMad(a,b,c)
  %FMad107 = call float @dx.op.tertiary.f32(i32 46, float %17, float %33, float %FMad108)  ; FMad(a,b,c)
  %45 = fadd fast float %FMad107, %38
  %46 = fmul fast float %24, %.i0156
  %FMad105 = call float @dx.op.tertiary.f32(i32 46, float %.i1157433, float %29, float %46)  ; FMad(a,b,c)
  %FMad104 = call float @dx.op.tertiary.f32(i32 46, float %17, float %34, float %FMad105)  ; FMad(a,b,c)
  %47 = fadd fast float %FMad104, %39
  ...
  %FMad90 = call float @dx.op.tertiary.f32(i32 46, float %.i1157433, float %60, float %74)  ; FMad(a,b,c)
  %FMad89 = call float @dx.op.tertiary.f32(i32 46, float %17, float %65, float %FMad90)  ; FMad(a,b,c)
  %75 = fadd fast float %FMad89, %70
  %76 = fmul fast float %56, %.i0156
  %FMad87 = call float @dx.op.tertiary.f32(i32 46, float %.i1157433, float %61, float %76)  ; FMad(a,b,c)
  %FMad86 = call float @dx.op.tertiary.f32(i32 46, float %17, float %66, float %FMad87)  ; FMad(a,b,c)
  %77 = fadd fast float %FMad86, %71
  %78 = fmul fast float %57, %.i0156
  %FMad84 = call float @dx.op.tertiary.f32(i32 46, float %.i1157433, float %62, float %78)  ; FMad(a,b,c)
  %FMad83 = call float @dx.op.tertiary.f32(i32 46, float %17, float %67, float %FMad84)  ; FMad(a,b,c)
  %79 = fadd fast float %FMad83, %72
  %80 = fmul fast float %58, %.i0156
  %FMad81 = call float @dx.op.tertiary.f32(i32 46, float %.i1157433, float %63, float %80)  ; FMad(a,b,c)
  %FMad80 = call float @dx.op.tertiary.f32(i32 46, float %17, float %68, float %FMad81)  ; FMad(a,b,c)
  %81 = fadd fast float %FMad80, %73
  ...
  %FMad144 = call float @dx.op.tertiary.f32(i32 46, float %.i1207, float %124, float %131)  ; FMad(a,b,c)
  %FMad143 = call float @dx.op.tertiary.f32(i32 46, float %.i2208, float %128, float %FMad144)  ; FMad(a,b,c)
  %132 = fmul fast float %121, %.i0206
  %FMad142 = call float @dx.op.tertiary.f32(i32 46, float %.i1207, float %125, float %132)  ; FMad(a,b,c)
  %FMad141 = call float @dx.op.tertiary.f32(i32 46, float %.i2208, float %129, float %FMad142)  ; FMad(a,b,c)
  %133 = fmul fast float %122, %.i0206
  %FMad140 = call float @dx.op.tertiary.f32(i32 46, float %.i1207, float %126, float %133)  ; FMad(a,b,c)
  %FMad139 = call float @dx.op.tertiary.f32(i32 46, float %.i2208, float %130, float %FMad140)  ; FMad(a,b,c)
  ...
  store <3 x float> %135, <3 x float>* %136, align 4, !tbaa !526
  %137 = getelementptr inbounds %struct.RayDesc, %struct.RayDesc* %ray, i32 0, i32 1
  store float 0.000000e+00, float* %137, align 4, !tbaa !541
  ...
  %FMad122 = call float @dx.op.tertiary.f32(i32 46, float %17, float %144, float 0.000000e+00)  ; FMad(a,b,c)
  %178 = fadd fast float %FMad122, %147
  %FMad116 = call float @dx.op.tertiary.f32(i32 46, float %17, float %145, float 0.000000e+00)  ; FMad(a,b,c)
  %179 = fadd fast float %FMad116, %148
  ...
  %FMad98 = call float @dx.op.tertiary.f32(i32 46, float %17, float %144, float %FMad99)  ; FMad(a,b,c)
  ...
  %FMad92 = call float @dx.op.tertiary.f32(i32 46, float %17, float %145, float %FMad93)  ; FMad(a,b,c)
  ...
  store i32 0, i32* %190, align 4, !tbaa !534
  ...
  %218 = load float, float* %168, align 4, !tbaa !541
  ...
  %224 = load float, float* %169, align 4, !tbaa !541
  ...
  %230 = load float, float* %170, align 4, !tbaa !541
  ...
  store float 0.000000e+00, float* %239, align 4, !tbaa !541
  ...
  %FMad138 = call float @dx.op.tertiary.f32(i32 46, float %.i1337, float %154, float %260)  ; FMad(a,b,c)
  %FMad137 = call float @dx.op.tertiary.f32(i32 46, float %.i2338, float %158, float %FMad138)  ; FMad(a,b,c)
  %261 = fadd fast float %FMad137, %162
  %262 = fmul fast float %.i0336, %151
  %FMad135 = call float @dx.op.tertiary.f32(i32 46, float %.i1337, float %155, float %262)  ; FMad(a,b,c)
  %FMad134 = call float @dx.op.tertiary.f32(i32 46, float %.i2338, float %159, float %FMad135)  ; FMad(a,b,c)
  %263 = fadd fast float %FMad134, %163
  %264 = fmul fast float %.i0336, %152
  %FMad129 = call float @dx.op.tertiary.f32(i32 46, float %.i1337, float %156, float %264)  ; FMad(a,b,c)
  %FMad128 = call float @dx.op.tertiary.f32(i32 46, float %.i2338, float %160, float %FMad129)  ; FMad(a,b,c)
  %265 = fadd fast float %FMad128, %164
...
._crit_edge:                                      ; preds = %._crit_edge.loopexit, %"\01?internal.getImportanceRay@@YA?AV?$vector@M$02@@V1@0MV?$vector@M$01@@@Z.exit"
  ...
  %FMad78 = call float @dx.op.tertiary.f32(i32 46, float %vReflectionDirectionInView.0.lcssa.i1, float %324, float %331)  ; FMad(a,b,c)
  %FMad77 = call float @dx.op.tertiary.f32(i32 46, float %vReflectionDirectionInView.0.lcssa.i2, float %328, float %FMad78)  ; FMad(a,b,c)
  %332 = fmul fast float %321, %vReflectionDirectionInView.0.lcssa.i0
  %FMad76 = call float @dx.op.tertiary.f32(i32 46, float %vReflectionDirectionInView.0.lcssa.i1, float %325, float %332)  ; FMad(a,b,c)
  %FMad75 = call float @dx.op.tertiary.f32(i32 46, float %vReflectionDirectionInView.0.lcssa.i2, float %329, float %FMad76)  ; FMad(a,b,c)
  %333 = fmul fast float %322, %vReflectionDirectionInView.0.lcssa.i0
  %FMad74 = call float @dx.op.tertiary.f32(i32 46, float %vReflectionDirectionInView.0.lcssa.i1, float %326, float %333)  ; FMad(a,b,c)
  %FMad = call float @dx.op.tertiary.f32(i32 46, float %vReflectionDirectionInView.0.lcssa.i2, float %330, float %FMad74)  ; FMad(a,b,c)
...
._crit_edge.31.loopexit:                          ; preds = %._crit_edge
  ...
  %FMad75.lcssa = phi float [ %FMad75, %._crit_edge ]
  %FMad77.lcssa = phi float [ %FMad77, %._crit_edge ]
  ...
  %341 = insertelement <3 x float> undef, float %FMad77.lcssa, i64 0
  %342 = insertelement <3 x float> %341, float %FMad75.lcssa, i64 1
  %343 = insertelement <3 x float> %342, float %FMad.lcssa, i64 2
