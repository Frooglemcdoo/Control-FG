...
def main():
    ...
    report={'build':'RTX50 HDR Button R22','baseline_zip_sha256':BASE_SHA,'baseline_core_sha256':CORE_SHA,
    ...
    (out/'HDR-BUTTON-R22-BUILD.json').write_text(json.dumps(report,indent=2))
