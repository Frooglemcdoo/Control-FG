...
allowed={'src/probe.cpp','src/rr_guide_render.h','src/rr_guide_export.h'}
unchanged=[]
if baseline.exists():
...
assert "Version = '1.0.0-RR-Native-G12-r6'" in metadata
...
summary={'version':'1.0.0-RR-Native-G12-r6','source_revision':'r6-rr-native-g12',
 ...
 'runtime_change':'GPU reflectance candidate generation from immutable same-frame capture; full-image CPU comparison before export',
 'gpu_reflectance':'implemented; Windows compilation and GPU execution pending','windows_msvc':'NOT_RUN','powershell_parser':'NOT_RUN_ON_THIS_HOST','runtime':'NOT_RUN',
...
out=root.parent/'Control-FG-v1.0.0-RR-Native-G12-r6-Full-Source.zip'
