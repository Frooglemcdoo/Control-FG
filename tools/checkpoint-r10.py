...
allowed={'src/probe.cpp','src/rr_diffuse_replay.h','src/rr_diffuse_join.h'}
unchanged=[]
if baseline.exists():
...
assert "Version = '1.0.0-RR-Native-G12-r10'" in metadata
...
summary={'version':'1.0.0-RR-Native-G12-r10','source_revision':'r10-rr-native-g12',
 ...
 'runtime_change':'Precise recurring diffuse join failure reasons, draw fault details and per-frame skip counts; rejection behavior unchanged; no RR evaluation',
 'gpu_reflectance':'r9 copied 376 diffuse frames then stopped; normal/specular retired 1706. r10 Windows execution pending','evaluation_entry_host_tests':'normal and ASan/UBSan PASS','live_emitter_retirement_slot_tests':'normal and ASan/UBSan PASS','windows_msvc':'NOT_RUN','powershell_parser':'NOT_RUN_ON_THIS_HOST','runtime':'NOT_RUN',
...
out=root.parent/'Control-FG-v1.0.0-RR-Native-G12-r10-Full-Source.zip'
