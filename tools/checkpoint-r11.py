"""Validate and package the r11 full source, without claiming Windows execution."""
...
if len(sys.argv)!=3: raise SystemExit('Usage: checkpoint-r11.py PATH_TO_R5_LOG_ZIP ORIGINAL_D3D_DLL')
...
allowed={'src/probe.cpp','src/rr_diffuse_replay.h'}
unchanged=[]
if baseline.exists():
...
assert "Version = '1.0.0-RR-Native-G12-r11'" in metadata
...
summary={'version':'1.0.0-RR-Native-G12-r11','source_revision':'r11-rr-native-g12',
 ...
 'runtime_change':'Select primary view before borrowed binding checks; preserve depth requirements and add rejected depth evidence; no RR evaluation',
 'gpu_reflectance':'r10 copied 581 diffuse frames before depth validation stopped replay. r11 Windows execution pending','evaluation_entry_host_tests':'normal and ASan/UBSan PASS','live_emitter_retirement_slot_tests':'normal and ASan/UBSan PASS','windows_msvc':'NOT_RUN','powershell_parser':'NOT_RUN_ON_THIS_HOST','runtime':'NOT_RUN',
...
out=root.parent/'Control-FG-v1.0.0-RR-Native-G12-r11-Full-Source.zip'
