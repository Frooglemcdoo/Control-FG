"""Validate and package the r14 full source, without claiming Windows execution."""
...
if len(sys.argv)!=4: raise SystemExit('Usage: checkpoint-r14.py PATH_TO_R5_LOG_ZIP ORIGINAL_D3D_DLL ORIGINAL_RENDERER_DLL')
...
allowed={'src/probe.cpp','src/rr_live_guides.h','src/rr_live_record.h','src/shaders/rr_live_guides.hlsl','src/rr_live_frame_input.h','src/rr_evaluation_entry.h'}
unchanged=[]
if baseline.exists():
...
assert "Version = '1.0.0-RR-Native-G12-r14'" in metadata
...
summary={'version':'1.0.0-RR-Native-G12-r14','source_revision':'r14-rr-native-g12',
 ...
 'runtime_change':'Native pixel jitter subtracted in inverse specular view ray; 80-byte reflected constants; RR evaluation disabled',
 'gpu_reflectance':'r12 stability pass: 1915 diffuse copies, 2112 live retirements, no stop. r14 Windows execution pending','evaluation_entry_host_tests':'normal and ASan/UBSan PASS','live_emitter_retirement_slot_tests':'normal and ASan/UBSan PASS','windows_msvc':'NOT_RUN','powershell_parser':'NOT_RUN_ON_THIS_HOST','runtime':'NOT_RUN',
...
out=root.parent/'Control-FG-v1.0.0-RR-Native-G12-r14-Full-Source.zip'
