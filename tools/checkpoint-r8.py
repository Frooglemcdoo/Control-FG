...
if len(sys.argv)!=3: raise SystemExit('Usage: checkpoint-r8.py PATH_TO_R5_LOG_ZIP ORIGINAL_D3D_DLL')
...
allowed={'src/probe.cpp','src/rr_evaluation_entry.h'}
unchanged=[]
if baseline.exists():
...
assert "Version = '1.0.0-RR-Native-G12-r8'" in metadata
...
summary={'version':'1.0.0-RR-Native-G12-r8','source_revision':'r8-rr-native-g12',
 ...
 'runtime_change':'Per-frame native GPU normal/roughness and specular candidates before native evaluation; three owned slots, native Present fence retirement, asynchronous resize; no RR evaluation',
 'gpu_reflectance':'r7 snapshot implementation unchanged and runtime passed; new per-frame dispatch Windows/GPU execution pending','evaluation_entry_host_tests':'normal and ASan/UBSan PASS','live_emitter_retirement_slot_tests':'normal and ASan/UBSan PASS','windows_msvc':'NOT_RUN','powershell_parser':'NOT_RUN_ON_THIS_HOST','runtime':'NOT_RUN',
...
out=root.parent/'Control-FG-v1.0.0-RR-Native-G12-r8-Full-Source.zip'
