...
if len(sys.argv)!=3: raise SystemExit('Usage: checkpoint-r9.py PATH_TO_R5_LOG_ZIP ORIGINAL_D3D_DLL')
...
allowed={'src/probe.cpp','src/rr_albedo_capture.h','src/rr_live_guides.h','src/rr_live_record.h','src/rr_live_retire.h','src/shaders/rr_live_guides.hlsl'}
unchanged=[]
if baseline.exists():
...
assert "Version = '1.0.0-RR-Native-G12-r9'" in metadata
...
summary={'version':'1.0.0-RR-Native-G12-r9','source_revision':'r9-rr-native-g12',
 ...
 'runtime_change':'Recurring native albedo replay with exact-frame join gate; GPU diffuse copy into third owned output, integer alpha normalization preserving RGB bits; no RR evaluation',
 'gpu_reflectance':'r8 normal/specular dispatch and fence retirement passed in supplied logs; recurring diffuse replay/copy Windows execution pending','evaluation_entry_host_tests':'normal and ASan/UBSan PASS','live_emitter_retirement_slot_tests':'normal and ASan/UBSan PASS','windows_msvc':'NOT_RUN','powershell_parser':'NOT_RUN_ON_THIS_HOST','runtime':'NOT_RUN',
...
out=root.parent/'Control-FG-v1.0.0-RR-Native-G12-r9-Full-Source.zip'
